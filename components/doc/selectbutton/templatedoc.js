	...
	return (
		<>
			<DocSectionText {...props}>
				<p>
					Options support templating using the <i>itemTemplate</i> property that
					references a function to render the content. Notice the usage of{" "}
					<i>optionLabel</i>, although not rendered visually, it is still
					required to be used as the list key.
				</p>
			</DocSectionText>
			<div className="card flex justify-content-center">
				<SelectButton
