		...
		<DevelopmentSection>
			<DocSectionText id="accessibility" label="Accessibility">
				...
				<p>
					...
					<i>aria-labelledby</i>, <i>aria-label</i> props. Chip list uses{" "}
					<i>listbox</i> role with <i>aria-orientation</i> set to horizontal
					whereas each chip has the <i>option</i> role with <i>aria-label</i>{" "}
					set to the label of the chip.
				</p>
