    ...
    return (
        <>
            <DocSectionText {...props}>
                <p>
                    Declarative is an alternative to the programmatic approach
                    where ConfirmDialog is controlled with a binding to{" "}
                    <i>visible</i> and <i>onHide</i> event callback along with
                    the <i>target</i> property to refer to the source element.
                </p>
            </DocSectionText>
            <Toast ref={toast} />
            <ConfirmPopup
