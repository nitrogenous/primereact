		...
		<>
			<DocSectionText {...props}>
				<p>
					...
					<i>closeOnEscape</i> is enabled to close the popop when ESC is
					pressed. The <i>dismissable</i> property when set to <i>false</i> will
					not close the popup when the document is clicked outside the popup.
				</p>
			</DocSectionText>
			<div className="card flex flex-column align-items-center gap-3">
				<Toast ref={toast} />
