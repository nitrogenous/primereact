	...
	return (
		<>
			<DocSectionText {...props}>
				<p>
					DataView supports <i>list</i> and <i>grid</i> display modes defined
					with the <i>layout</i> property. The helper{" "}
					<i>DataViewLayoutOptions</i> component can be used to switch between
					the modes however this component is optional and you may use your own
					UI to switch modes as well. As in <i>list</i> layout, the <i>grid</i>{" "}
					layout also requires PrimeFlex Grid classes to define how the grid is
					displayed per screen sizes.
				</p>
			</DocSectionText>
			<div className="card">
				<DataView
