    ...
    return (
        <>
            <DocSectionText {...props}>
                <p>
                    The <i>threshold</i> option defines the percentage of how
                    much of the element should be visible, for example{" "}
                    <i>0.5</i> means at least half of the element.
                </p>
            </DocSectionText>
            <div className="card flex flex-column align-items-center">
                ...
                <div
                    className="border-dashed surface-border border-round w-20rem overflow-y-scroll p-3"
                    style={{ height: "300px" }}
                >
                    <div
                    ...
                    >
                        <div
                            ...
                            className={classNames(
                                "w-full h-8rem border-round p-3 font-bold border-1 border-primary flex align-items-center justify-content-center transition-all transition-duration-300",
                                { "bg-primary": visible },
                            )}
                        >
