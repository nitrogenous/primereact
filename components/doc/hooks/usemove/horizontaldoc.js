    ...
    return (
        <>
            <DocSectionText {...props}>
                <p>
                    A horizontal slider implementation by utilizing the x-axis
                    only.
                </p>
            </DocSectionText>
            <div className="card flex flex-column align-items-center gap-3">
                <div
                    ref={ref}
                    className="flex align-items-center justify-content-center relative surface-ground w-14rem z-1"
                    style={{ height: "8px" }}
                >
                    <div
