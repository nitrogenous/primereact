    ...
    return (
        <>
            <DocSectionText {...props}>
                <p>
                    When any ancestor component of the button is scrolled, the
                    overlay gets hidden. This is especially useful to avoid
                    alignment issues when the overlay is attached to the
