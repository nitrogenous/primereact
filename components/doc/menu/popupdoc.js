	...
	return (
		<>
			<DocSectionText {...props}>
				<p>
					Popup mode is enabled by adding <i>popup</i> property and calling{" "}
					<i>toggle</i> method with an event of the target. The{" "}
					<i>popupAlignment</i> property allows you to control how the overlay
					is aligned with its target.
				</p>
			</DocSectionText>
			<div className="card flex justify-content-center">
				<Toast ref={toast}></Toast>
