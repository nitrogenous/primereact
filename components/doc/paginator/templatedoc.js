    ...
    return (
        <>
            <DocSectionText {...props}>
                <p>
                    Templating allows overriding the default content of the UI
                    elements by defining callbacks using the element name. The
                    parameters passed to theese callbacks contain properties for
                    binding to your custom elements like the event handler to
                    trigger pagination. Additional <i>leftContent</i> and{" "}
                    <i>rightContent</i> properties are available to insert
                    content at both sides of the paginator.
                </p>
            </DocSectionText>
            <div className="card">
                <Paginator
