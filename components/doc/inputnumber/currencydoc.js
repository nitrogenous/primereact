    ...
    return (
        <>
            <DocSectionText {...props}>
                <p>
                    Monetary values are enabled by setting <i>mode</i> property
                    as <i>currency</i>. In this setting, <i>currency</i>{" "}
                    property also needs to be defined using ISO 4217 standard
