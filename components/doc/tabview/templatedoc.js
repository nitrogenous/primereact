    ...
    return (
        <>
            <DocSectionText {...props}>
                <p>
                    Title section of a tab is customized with the <i>header</i>{" "}
                    property that takes a <i>TabPanelHeaderTemplateOptions</i>{" "}
                    object as a parameter and returns content.
                </p>
            </DocSectionText>
