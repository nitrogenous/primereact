	...
	return (
		<>
			<DocSectionText {...props}>
				<p>
					TreeSelect is used as a controlled component with <i>value</i> and{" "}
					<i>onChange</i> properties along with an <i>options</i> collection.
					Internally <Link href="tree">Tree</Link> component is used so the
					options model is based on TreeNode API.
				</p>
				<p>
					In single selection mode, value binding should be the <i>key</i> value
					of a node.
				</p>
			</DocSectionText>
			<div className="card flex justify-content-center">
