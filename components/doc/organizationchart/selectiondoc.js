	...
	return (
		<>
			<DocSectionText {...props}>
				<p>
					Nodes can be selected by defining <i>selectionMode</i> along with a
					value binding with <i>selection</i> and <i>onSelectionChange</i>{" "}
					properties. By default only one node can be selected, set{" "}
					<i>selectionMode</i>
