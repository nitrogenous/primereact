	...
	return (
		<>
			<DocSectionText {...props}>
				<p>
					Full screen mode is enabled by adding <i>fullScreen</i> property and
					the <i>ref</i> of the Galleria needs to be defined so that <i>show</i>{" "}
					method can be called from a target like a button.
				</p>
			</DocSectionText>
			<div className="card flex justify-content-center">
				<Galleria
