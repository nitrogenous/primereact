	...
	return (
		<>
			<DocSectionText {...props}>
				<p>
					Indicators can be placed at four different sides using the{" "}
					<i>indicatorsPosition</i> property. In addition, enabling{" "}
					<i>showIndicatorsOnItem</i> moves the indicators inside the image
					section.
				</p>
			</DocSectionText>
			<div className="card">
