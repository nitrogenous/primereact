    ...
    return (
        <>
            <DocSectionText {...props}>
                <p>
                    This section assumes that Tailwind is already available in
                    your application, if not visit the Tailwind CSS{" "}
                    <a href="https://tailwindcss.com/docs/installation/framework-guides">
                        framework guides{" "}
                    </a>
                    like Vite for the installation and make sure to apply the
                    CSS layer configuration above when including the styles of
                    Tailwind as well.
                </p>
                <p className="flex align-items-start gap-2">
                    ...
                    <span>
                        ...
                        <i>node_modules</i> the <i>content</i> property at{" "}
                        <i>tailwind.config.js</i> needs to be aware of
                        PrimeReact, otherwise the classes utilized in the theme
                ...
                <p className="flex align-items-start gap-2">
                    ...
                    <span>
                        ...
                        adding an empty <i>pt</i> so that they can be styled
                        with Tailwind in the next section. Note that if you run
                        your application at this stage, functionality and
                        accessibility of the components will still work but
                        everything will be transparent as there is no style.
                    </span>
                </p>
                <DocSectionCode
                    code={code2}
                ...
                <p className="flex align-items-start gap-2">
                    ...
                    <span>
                        ...
                        . This will prevent classNames specified in the global
                        pass through from overriding those specified via pass
                ...
                <p className="flex align-items-start gap-2">
                    ...
                    <span>
                        ...
                        The default preset of each component is available at the
                        Tailwind part under theming section of each component so
                        you'll able to copy paste instead of starting from
                        scratch. Example below styles, inputtext and panel
                        components;
                    </span>
                </p>
                <DocSectionCode
                ...
                />
                <p>
                    Voilà 💙, you now have 90+ awesome React UI components
                    styled with Tailwind that will work in harmony with the rest
                    of your application. Time to customize it to bring in your
                    own style with Tailwind.
                </p>
            </DocSectionText>
        </>
    );
