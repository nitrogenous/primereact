...
export function GMapDoc(props) {
    ...
    const loadGoogleMaps = (callback) => {
        ...
        if (!existingScript) {
            ...
            script.src =
                "https://maps.google.com/maps/api/js?key=AIzaSyA6Ar0UymhiklJBzEPLKKn2QHwbjdz3XV0";
    ...
    return (
        <>
            <DocSectionText {...props}>
                <p>
                    Applying <i>p-invalid</i> class to an input element
                ...
                <div className="grid p-fluid">
                    ...
                    <div className="col-10">
                        <InputText
                            readOnly
                            value={
                                selectedPosition ? selectedPosition.lat() : ""
                            }
                        />
                    </div>
                    ...
                    <div className="col-10">
                        <InputText
                            readOnly
                            value={
                                selectedPosition ? selectedPosition.lng() : ""
                            }
                        />
                    </div>
