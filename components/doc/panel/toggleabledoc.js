        ...
        <>
            <DocSectionText {...props}>
                <p>
                    ...
                    <i>toggleable</i> option is enabled. A toggleable panel can
                    either be used as a Controlled or Uncontrolled component. In
                    controlled mode a binding to <i>collapsed</i> property along
                    with <i>onToggle</i> event are needed to manage the content
                    state.
                </p>
            </DocSectionText>
            <div className="card">
