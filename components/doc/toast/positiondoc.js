    ...
    return (
        <>
            <DocSectionText {...props}>
                <p>
                    Location of the messages is customized with the{" "}
            ...
            <div className="card flex justify-content-center">
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    <Button
                        ...
                        className="p-button-success"
                        onClick={(e) =>
                            showMessage(e, toastBottomLeft, "success")
                        }
                    />
                    <Button
                        label="Bottom Center"
                        onClick={(e) =>
                            showMessage(e, toastBottomCenter, "info")
                        }
                    />
                    <Button
                        label="Bottom Right"
                        className="p-button-warning"
                        onClick={(e) =>
                            showMessage(e, toastBottomRight, "warn")
                        }
                    />
                </div>
            </div>
