    ...
    return (
        <>
            <DocSectionText {...props}>
                <p>
                    Busy state is enabled by adding <i>showLoader</i> property
                    which blocks the UI with a modal by default. Alternatively,{" "}
                    <i>loadingTemplate</i> can be used to customize items e.g.
                    with <Link href="/skeleton">Skeleton</Link>.
                </p>
            </DocSectionText>
            <div className="card flex flex-wrap justify-content-center gap-5">
                <div>
