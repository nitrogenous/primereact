    ...
    return (
        <>
            <DocSectionText {...props}>
                <p>
                    Default styling of the animation adds a shade of white. This
                    can easily be customized using css that changes the color of{" "}
                    <i>p-ink</i> element.
                </p>
            </DocSectionText>
            <div className="card flex justify-content-center align-items-center gap-2">
                ...
                <div className="p-ripple p-5 border-round border-radius-10 shadow-2">
                    ...
                    <Ripple
                        pt={{
                            root: {
                                style: { background: "rgba(255, 193, 6, 0.3)" },
                            },
                        }}
                    />
                </div>
