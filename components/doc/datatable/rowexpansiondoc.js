    ...
    return (
        <>
            <DocSectionText {...props}>
                <p>
                    Row expansion is controlled with <i>expandedRows</i> and{" "}
                    <i>onRowToggle</i> properties. The column that has the
                    expander element requires <i>expander</i> property to be
                    enabled. Optional <i>onRowExpand</i> and{" "}
                    <i>onRowCollapse</i> events are available as callbacks.
                </p>
                <p>
                    Expanded rows can either be an array of row data or when{" "}
                    <i>dataKey</i> is present, an object whose keys are strings
                    referring to the identifier of the row data and values are
                    booleans to represent the expansion state e.g.{" "}
                    <i>&#123;'1004': true&#125;</i>. The <i>dataKey</i>{" "}
                    alternative is more performant for large amounts of data.
                </p>
            </DocSectionText>
