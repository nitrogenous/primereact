	...
	return (
		<>
			<DocSectionText {...props}>
				<p>
					Single row selection is enabled by defining <i>selectionMode</i> as{" "}
					<i>single</i> along with a value binding using <i>selection</i> and{" "}
					<i>onSelectionChange</i> properties. When available, it is suggested
					to provide a unique identifier of a row with <i>dataKey</i> to
					optimize performance.
				</p>
				<p>
					By default, metaKey press (e.g. <i>⌘</i>) is necessary to unselect a
					row however this can be configured with disabling the{" "}
