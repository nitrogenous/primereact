	...
	return (
		<>
			<DocSectionText {...props}>
				<p>
					Specifying <i>selectionMode</i> as <i>multiple</i> on a Column,
					displays a checkbox inside that column for selection. By default, row
					clicks also trigger selection, set <i>selectionMode</i>
					of DataTable to <i>checkbox</i> to only trigger selection using the
					checkboxes.
				</p>
				<p>
					The header checkbox toggles the selection state of the whole dataset
					by default, when paginator is enabled you may add{" "}
					<i>selectionPageOnly</i> to only control the selection of visible
					rows.
				</p>
			</DocSectionText>
