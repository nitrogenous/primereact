    ...
    return (
        <>
            <DocSectionText {...props}>
                <p>
                    Columns can be grouped within a <i>Row</i> component and
                    groups can be displayed at header and footer using{" "}
                    <i>headerColumnGroup</i>, <i>footerColumnGroup</i>{" "}
                    properties. Number of cells and rows to span are defined
                    with the <i>colSpan</i> and <i>rowSpan</i> properties of a
                    Column.
                </p>
            </DocSectionText>
