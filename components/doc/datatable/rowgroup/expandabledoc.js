    ...
    return (
        <>
            <DocSectionText {...props}>
                <p>
                    When <i>expandableRowGroups</i> is present in subheader
                    based row grouping, groups can be expanded and collapsed.
                    State of the expansions are controlled using the{" "}
                    <i>expandedRows</i> and <i>onRowToggle</i> properties.
                </p>
            </DocSectionText>
