    ...
    return (
        <>
            <DocSectionText {...props}>
                <p>
                    More than one cell is selectable by setting{" "}
                    ...
                    property. Note that in touch enabled devices, DataTable
                    always ignores metaKey.
                </p>
                <p>
                    Additionaly, multiple cells can be selected using drag when{" "}
                    <i>dragSelection</i> is present.
                </p>
            </DocSectionText>
