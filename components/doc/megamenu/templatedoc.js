...
export function TemplateDoc(props) {
    const itemRenderer = (item) => {
        if (item.root) {
            return (
                <a
                    className="flex align-items-center cursor-pointer px-3 py-2 overflow-hidden relative font-semibold text-lg uppercase p-ripple"
    ...
    return (
        <>
            <DocSectionText {...props}>
                <p>
                    Custom content can be placed inside the megamenu using the{" "}
                    <i>start</i> and <i>end</i> properties.
                </p>
            </DocSectionText>
            <div className="card">
                <MegaMenu
