    ...
    return (
        <>
            <DocSectionText {...props}>
                <p>
                    ContextMenu offers item customization with the items{" "}
                    <i>template</i> property that receives the item instance and
                    returns an element.
                </p>
            </DocSectionText>
            <div className="card flex md:justify-content-center">
                    ...
                    {products.map((product) => (
                        <li
                            ...
                            className={`p-2 hover:surface-hover border-round border-1 border-transparent transition-all transition-duration-200 ${
                                selectedId === product.id && "border-primary"
                            }`}
                            onContextMenu={(e) => onRightClick(e, product.id)}
                        >
                            <div className="flex flex-wrap p-2 align-items-center gap-3">
                                ...
                                <span className="font-bold text-900 ml-5">
                                    {product.price}
                                </span>
                            </div>
                        </li>
