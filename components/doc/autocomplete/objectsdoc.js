    ...
    return (
        <>
            <DocSectionText {...props}>
                <p>
                    AutoComplete can work with objects using the <i>field</i>{" "}
                    property that defines the label to display as a suggestion.
                    The value passed to the model would still be the object
                    instance of a suggestion. Here is an example with a Country
                    object that has name and code fields such as{" "}
