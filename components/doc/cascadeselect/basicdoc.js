    ...
    return (
        <>
            <DocSectionText {...props}>
                <p>
                    CascadeSelect is used as a controlled component with{" "}
                    <i>value</i> and <i>onChange</i> properties along with an{" "}
                    <i>options</i> collection. To define the label of a group{" "}
                    <i>optionGroupLabel</i> property is needed and also{" "}
                    <i>optionGroupChildren</i> is required to define the
                    property that refers to the children of a group. Note that
                    order of the <i>optionGroupChildren</i> matters as it should
                    correspond to the data hierarchy.
                </p>
            </DocSectionText>
            <div className="card flex justify-content-center">
                <CascadeSelect
