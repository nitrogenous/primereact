        ...
        <>
            <DocSectionText {...props}>
                <p>
                    ...
                    <i>multiple</i> property to choose more than one. When the
                    optional <i>metaKeySelection</i> is present, behavior is
                    changed in a way that selecting a new item requires meta key
                    to be present.
                </p>
            </DocSectionText>
            <div className="card flex justify-content-center">
