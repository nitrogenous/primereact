	...
	return (
		<>
			<DocSectionText {...props}>
				<p>
					Custom content for an option is displayed with the <i>itemTemplate</i>{" "}
					property that takes an option as a parameter. Additional available
					templating sections are <i>filterTemplate</i> and{" "}
					<i>optionGroupTemplate</i>.
				</p>
			</DocSectionText>
			<div className="card flex justify-content-center">
				<ListBox
