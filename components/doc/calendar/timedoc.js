    ...
    return (
        <>
            <DocSectionText {...props}>
                <p>
                    A time picker is displayed when <i>showTime</i> is enabled
                    where 12/24 hour format is configured with <i>hourFormat</i>{" "}
                    property. In case, only time needs to be selected, add{" "}
                    <i>timeOnly</i> to hide the date section.
                </p>
            </DocSectionText>
            <div className="card flex flex-wrap gap-3 p-fluid">
                <div className="flex-auto">
