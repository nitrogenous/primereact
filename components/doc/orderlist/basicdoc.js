	...
	return (
		<>
			<DocSectionText {...props}>
				<p>
					OrderList is used as a controlled input with <i>value</i> and{" "}
					<i>onChange</i> properties. Content of a list item needs to be defined
					with the <i>itemTemplate</i> property that receives an object in the
					list as parameter.
				</p>
			</DocSectionText>
			<div className="card xl:flex xl:justify-content-center">
