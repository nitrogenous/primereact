	...
	return (
		<>
			<DocSectionText {...props}>
				<p>
					Surface palette is used when designing the layers such as headers,
					content, footers, overlays and dividers. Surface palette varies
					between 0 - 900 and named surfaces are also available.
				</p>
			</DocSectionText>
			<div className="card">
				<div className="flex flex-column">
					{shades.map((shade) => {
						return (
							<div
								key={shade}
								className="w-18rem flex align-items-center p-3 font-bold"
								style={{
									backgroundColor: `var(--surface-${shade})`,
									color:
										shade < 600 ? "var(--surface-900)" : "var(--surface-0)",
								}}
							>
								--surface-{shade}
							</div>
