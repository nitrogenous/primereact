    ...
    return (
        <>
            <DocSectionText {...props}>
                <p>
                    Surface palette is used when designing the layers such as
                    headers, content, footers, overlays and dividers. Surface
                    palette varies between 0 - 900 and named surfaces are also
                    available.
                </p>
            </DocSectionText>
            <div className="card">
                ...
                <table className="doc-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                Background color of a section on a ground
                                surface.
                            </td>
                        </tr>
                        <tr>
