    ...
    return (
        <>
            <DocSectionText id="style" label="Style">
                <p>
                    Following is the list of structural style classes, for
                    theming classes visit <Link href="/theming"> theming</Link>{" "}
                    page.
                </p>
            </DocSectionText>
                ...
                <table className="doc-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                Container of the label to display selected
                                items.
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                A selected item element container on
                                display='chip' mode.
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                Icon of a selected item element on
                                display='chip' mode.
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                Label of a selected item element on
                                display='chip' mode.
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                Label to display when selectAllLabel is defined.
                            </td>
                        </tr>
                    </tbody>
                </table>
