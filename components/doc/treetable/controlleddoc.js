	...
	return (
		<>
			<DocSectionText {...props}>
				<p>
					Expansion state is controlled with <i>expandedKeys</i> and{" "}
					<i>onToggle</i> properties. The <i>expandedKeys</i> should be an
					object whose keys refer to the node key and values represent the
					expanded state e.g. <i>&#123;'0-0': true&#125;</i>.
				</p>
			</DocSectionText>
			<div className="card">
				<Button onClick={toggleApplications} label="Toggle Applications" />
