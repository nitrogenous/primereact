	...
	return (
		<>
			<DocSectionText {...props}>
				<p>
					Custom content at <i>header</i>, <i>body</i> and <i>footer</i>{" "}
					sections are supported via templating. The toggler can be customized
					with the <i>togglerTemplate</i> property.
				</p>
			</DocSectionText>
			<div className="card">
				<TreeTable
