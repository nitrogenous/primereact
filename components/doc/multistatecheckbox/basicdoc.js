	...
	return (
		<>
			<DocSectionText {...props}>
				<p>
					MultiStateCheckbox is used as a controlled input with <i>value</i> and{" "}
					<i>onChange</i> properties along with the <i>option</i> collection.
					The <i>optionValue</i> field refers to the value of each option, if
					ommitted the object itself becomes the value of an option. The icon to
					display is retrieved from the <i>optionIcon</i> property that defaults
					to <i>icon</i> property name.
				</p>
			</DocSectionText>
			<div className="card flex flex-column align-items-center gap-3">
				<MultiStateCheckbox
