...
export declare type OrganizationChartPassThroughType<T> = PassThroughType<
    T,
 ...
 * @group Component
 */
export declare class OrganizationChart extends React.Component<
