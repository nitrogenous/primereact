 ...
 */
interface VirtualScrollerLoadingTemplateOptions
    extends VirtualScrollerTemplateOptions {
    /**
...
export interface VirtualScrollerProps {
    ...
    loaderIconTemplate?:
        | React.ReactNode
        | ((
              options: VirtualScrollerLoaderIconTemplateOptions,
          ) => React.ReactNode);
    /**
