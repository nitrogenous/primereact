...
export declare type SlideMenuPassThroughType<T> = PassThroughType<
    T,
    SlideMenuPassThroughMethodOptions
>;
export declare type SlideMenuPassThroughTransitionType =
    | ReactCSSTransitionProps
    | ((options: SlideMenuPassThroughMethodOptions) => ReactCSSTransitionProps)
    | undefined;
...
export interface SlideMenuPassThroughOptions {
     ...
     */
    previousIcon?: SlideMenuPassThroughType<
        React.SVGProps<SVGSVGElement> | React.HTMLAttributes<HTMLSpanElement>
    >;
    /**
     * Uses to pass attributes to the previous label's DOM element.
     */
    previousLabel?: SlideMenuPassThroughType<
     ...
     */
    submenuIcon?: SlideMenuPassThroughType<
        React.SVGProps<SVGSVGElement> | React.HTMLAttributes<HTMLSpanElement>
    >;
    /**
