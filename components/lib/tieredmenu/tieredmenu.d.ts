...
>;
export declare type TieredMenuPassThroughTransitionType =
	| ReactCSSTransitionProps
	| ((options: TieredMenuPassThroughMethodOptions) => ReactCSSTransitionProps)
	| undefined;
...
export interface TieredMenuPassThroughOptions {
	 ...
	 */
	icon?: TieredMenuPassThroughType<
	 ...
	 */
	submenuIcon?: TieredMenuPassThroughType<
		React.SVGProps<SVGSVGElement> | React.HTMLAttributes<HTMLSpanElement>
	>;
	/**
