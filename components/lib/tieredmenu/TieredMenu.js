...
export const TieredMenu = React.memo(
    React.forwardRef((inProps, ref) => {
        ...
        const [bindDocumentClickListener, unbindDocumentClickListener] =
            useEventListener({
                ...
                listener: (event) => {
                    ...
                    const isOutsideTarget = props.popup
                        ? !(
                              targetRef.current &&
        ...
        const hide = (event, isFocus) => {
            ...
            isFocus &&
                DomHandler.focus(
                    relatedTarget.current || targetRef.current || menuElement,
                );
            setDirty(false);
        };
        ...
        const onArrowLeftKey = (event) => {
            ...
            setActiveItemPath(
                activeItemPath.filter(
                    (p) => p.parentKey !== focusedItemInfo.parentKey,
                ),
            );
                    ...
                    <div {...rootProps}>
                        <TieredMenuSub
                            ...
                            ariaActiveDescendant={
                                focused ? focusedItemId : undefined
                            }
                            menuId={idState}
                            level={0}
