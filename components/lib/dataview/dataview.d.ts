...
export declare type DataViewPassThroughType<T> = PassThroughType<
    T,
    DataViewPassThroughMethodOptions
>;
export declare type DataViewLayoutOptionsPassThroughType<T> = PassThroughType<
    T,
...
export interface DataViewPassThroughOptions {
     ...
     */
    emptyMessage?: DataViewPassThroughType<
     ...
     */
    loadingOverlay?: DataViewPassThroughType<
        React.HTMLAttributes<HTMLDivElement>
    >;
    /**
     * Uses to pass attributes to the loading icon's DOM element.
     */
    loadingIcon?: DataViewPassThroughType<
 ...
 */
export declare class DataViewLayoutOptions extends React.Component<
