...
export const DataViewLayoutOptions = React.memo((inProps) => {
    ...
    const listIcon = IconUtils.getJSXIcon(
        props.listIcon || <BarsIcon {...listIconProps} />,
        { ...listIconProps },
        { props },
    );
    const gridIcon = IconUtils.getJSXIcon(
        props.gridIcon || <ThLargeIcon {...gridIconProps} />,
        { ...gridIconProps },
        { props },
    );
    ...
    React.forwardRef((inProps, ref) => {
        ...
        const getItemRenderKey = (value) => {
            return props.dataKey
                ? ObjectUtils.resolveFieldData(value, props.dataKey)
                : null;
        };
        ...
        const sort = () => {
            if (props.value) {
                ...
                for (const item of value) {
                    lookupMap.set(
                        item,
                        ObjectUtils.resolveFieldData(item, props.sortField),
                    );
                }
