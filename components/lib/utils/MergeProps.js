export function _mergeProps(props, options = {}) {
    if (props) {
        ...
        const isFn = (o) => !!(o?.constructor && o.call && o.apply);
            ...
            for (const key in ps) {
                ...
                if (key === "style") {
                    ...
                    if (
                        ...
                        classNameMergeFunction instanceof Function
                    ) {
                        newClassname = classNameMergeFunction(
                            merged.className,
                            ps.className,
                        );
                    } else {
                        newClassname = [merged.className, ps.className]
                            .join(" ")
                            .trim();
                    }
        ...
        return props.reduce((merged, ps) => {
            for (const key in ps) {
                ...
                if (key === "style") {
                    ...
                    merged.className = [merged.className, ps.className]
                        .join(" ")
                        .trim();
                } else if (isFn(value)) {
                    const fn = merged[key];
