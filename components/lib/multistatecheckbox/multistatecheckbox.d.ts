...
export declare type MultiStateCheckboxPassThroughType<T> = PassThroughType<
    T,
...
export interface MultiStateCheckboxPassThroughOptions {
     ...
     */
    root?: MultiStateCheckboxPassThroughType<
        React.HTMLAttributes<HTMLDivElement>
    >;
    /**
     * Uses to pass attributes to the checkbox box's DOM element.
     */
    checkbox?: MultiStateCheckboxPassThroughType<
        React.HTMLAttributes<HTMLDivElement>
    >;
    /**
     ...
     */
    icon?: MultiStateCheckboxPassThroughType<
     ...
     */
    srOnlyAria?: MultiStateCheckboxPassThroughType<
...
export interface MultiStateCheckboxProps
    ...
    iconTemplate?:
        | React.ReactNode
        | ((options: MultiStateCheckboxIconTemplateEvent) => React.ReactNode);
    /**
 ...
 * @group Component
 */
export declare class MultiStateCheckbox extends React.Component<
