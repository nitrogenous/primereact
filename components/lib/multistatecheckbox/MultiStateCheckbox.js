...
export const MultiStateCheckbox = React.memo(
    React.forwardRef((inProps, ref) => {
        ...
        const getOptionAriaLabel = (option) => {
            ...
            return ariaField
                ? ObjectUtils.resolveFieldData(option, ariaField)
                : option;
        };
        ...
        const getSelectedOptionMap = () => {
            ...
            if (props.options) {
                index = props.options.findIndex((option) =>
                    ObjectUtils.equals(
                        props.value,
        ...
        const createIcon = () => {
            ...
            const content = IconUtils.getJSXIcon(
                icon,
                { ...iconProps },
                { props },
            );
        ...
        const { option: selectedOption, index: selectedOptionIndex } =
        ...
        const ariaValueLabel = selectedOption
            ? getOptionAriaLabel(selectedOption)
            : ariaLabel("nullLabel");
