...
export declare type SplitButtonPassThroughTransitionType =
    ...
    | ((
          options: SplitButtonPassThroughMethodOptions,
      ) => ReactCSSTransitionProps)
    | undefined;
...
export interface SplitButtonPassThroughOptions {
     ...
     */
    icon?: SplitButtonPassThroughType<
     ...
     */
    menuList?: SplitButtonPassThroughType<
