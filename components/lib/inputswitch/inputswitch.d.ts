...
export declare type InputSwitchPassThroughType<T> = PassThroughType<
    T,
...
export interface InputSwitchPassThroughOptions {
     ...
     */
    hiddenInputWrapper?: InputSwitchPassThroughType<
        React.HTMLAttributes<HTMLDivElement>
    >;
    /**
     * Uses to pass attributes to the hidden input's DOM element.
     */
    hiddenInput?: InputSwitchPassThroughType<
 ...
 * @group Component
 */
export declare class InputSwitch extends React.Component<
    InputSwitchProps,
    any
> {
    /**
