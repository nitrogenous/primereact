    ...
    React.forwardRef((inProps, ref) => {
        ...
        const [bindOverlayListener, unbindOverlayListener] = useOverlayListener(
            {
                ...
                listener: (event, { type, valid }) => {
                    if (valid) {
                        type === "outside"
                            ? !isOverlayClicked.current &&
                              !isNavIconClicked(event.target) &&
                              hide("outside", reFocusInputField)
        ...
        const initFocusableCell = () => {
            ...
            if (currentView === "month") {
                const cells = DomHandler.find(
                    overlayRef.current,
                    '[data-pc-section="monthpicker"] [data-pc-section="month"]',
                );
                const selectedCell = DomHandler.findSingle(
                    overlayRef.current,
                    '[data-pc-section="monthpicker"] [data-pc-section="month"][data-p-highlight="true"]',
                );
            ...
            if (currentView) {
                ...
                if (currentView === "date") {
                    ...
                    if (!cell) {
                        cell = DomHandler.findSingle(
                            overlayRef.current,
                            `[data-pc-section="${currentView}picker"] [data-pc-section="${currentView}"]:not([data-p-disabled="true"])`,
                        );
                    }
                }
        ...
        const navBackward = (event) => {
            ...
            const newViewDate = cloneDate(getViewDate());
        ...
        const decrementYear = () => {
            ...
            if (props.yearNavigator && _currentYear < yearOptions[0]) {
                ...
                populateYearOptions(
                    yearOptions[0] - difference,
                    yearOptions[yearOptions.length - 1] - difference,
                );
            }
        ...
        const incrementYear = () => {
            ...
            if (
                props.yearNavigator &&
                _currentYear.current > yearOptions[yearOptions.length - 1]
            ) {
                const difference =
                    yearOptions[yearOptions.length - 1] - yearOptions[0];
        ...
        const onMonthDropdownChange = (event, value) => {
            ...
            const newViewDate = cloneDate(currentViewDate);
        ...
        const incrementHour = (event) => {
            ...
            if (validateHour(newHour, currentTime)) {
                if (
                    props.maxDate &&
                    props.maxDate.toDateString() ===
                        currentTime.toDateString() &&
                    props.maxDate.getHours() === newHour
                ) {
                    if (props.maxDate.getMinutes() < currentTime.getMinutes()) {
                        if (
                            props.maxDate.getSeconds() <
                            currentTime.getSeconds()
                        ) {
                            if (
                                props.maxDate.getMilliseconds() <
                        ...
                        props.maxDate.getMinutes() === currentTime.getMinutes()
                    ) {
                        if (
                            props.maxDate.getSeconds() <
                            currentTime.getSeconds()
        ...
        const decrementHour = (event) => {
            ...
            if (validateHour(newHour, currentTime)) {
                if (
                    props.minDate &&
                    props.minDate.toDateString() ===
                        currentTime.toDateString() &&
                    props.minDate.getHours() === newHour
                ) {
                    if (props.minDate.getMinutes() > currentTime.getMinutes()) {
                        ...
                        props.minDate.getMinutes() === currentTime.getMinutes()
                    ) {
                        if (
                            props.minDate.getSeconds() >
                            currentTime.getSeconds()
        ...
        const incrementMinute = (event) => {
            ...
            if (validateMinute(newMinute, currentTime)) {
                if (
                    ...
                    props.maxDate.toDateString() ===
                        currentTime.toDateString() &&
                    props.maxDate.getMinutes() === newMinute
                ) {
        ...
        const decrementMinute = (event) => {
            ...
            if (validateMinute(newMinute, currentTime)) {
                if (
                    ...
                    props.minDate.toDateString() ===
                        currentTime.toDateString() &&
                    props.minDate.getMinutes() === newMinute
                ) {
        ...
        const incrementSecond = (event) => {
            ...
            if (validateSecond(newSecond, currentTime)) {
                if (
                    ...
                    props.maxDate.toDateString() ===
                        currentTime.toDateString() &&
                    props.maxDate.getSeconds() === newSecond
                ) {
                    if (
                        props.maxDate.getMilliseconds() <
                        currentTime.getMilliseconds()
        ...
        const decrementSecond = (event) => {
            ...
            if (validateSecond(newSecond, currentTime)) {
                if (
                    ...
                    props.minDate.toDateString() ===
                        currentTime.toDateString() &&
                    props.minDate.getSeconds() === newSecond
                ) {
                    if (
                        props.minDate.getMilliseconds() >
                        currentTime.getMilliseconds()
        ...
        const toggleAmPm = (event) => {
            ...
            if (
                validateHour(
                    convertTo24Hour(newHour, !(currentHour > 11)),
                    currentTime,
                )
            ) {
                updateTime(
        ...
        const getViewDate = (date) => {
            ...
            const viewDate =
                date ||
                (props.onViewDateChange ? props.viewDate : viewDateState);
        ...
        const validateHour = (hour, value) => {
            ...
            if (
                props.minDate &&
                valueDateString &&
                props.minDate.toDateString() === valueDateString
            ) {
            ...
            if (
                props.maxDate &&
                valueDateString &&
                props.maxDate.toDateString() === valueDateString
            ) {
        ...
        const validateSecond = (second, value) => {
            ...
            if (
                ...
                if (
                    value.getHours() === props.minDate.getHours() &&
                    value.getMinutes() === props.minDate.getMinutes()
                ) {
            ...
            if (
                ...
                if (
                    value.getHours() === props.maxDate.getHours() &&
                    value.getMinutes() === props.maxDate.getMinutes()
                ) {
        ...
        const validateMillisecond = (millisecond, value) => {
            ...
            if (
                ...
                if (
                    value.getHours() === props.minDate.getHours() &&
                    value.getSeconds() === props.minDate.getSeconds() &&
                    value.getMinutes() === props.minDate.getMinutes()
                ) {
            ...
            if (
                ...
                if (
                    value.getHours() === props.maxDate.getHours() &&
                    value.getSeconds() === props.maxDate.getSeconds() &&
                    value.getMinutes() === props.maxDate.getMinutes()
                ) {
        ...
        const validateDate = (value) => {
            if (props.yearNavigator) {
                ...
                const minRangeYear = props.yearRange
                    ? parseInt(props.yearRange.split(":")[0], 10)
                    : null;
                const maxRangeYear = props.yearRange
                    ? parseInt(props.yearRange.split(":")[1], 10)
                    : null;
                const minYear =
                    props.minDate && minRangeYear != null
                        ? Math.max(props.minDate.getFullYear(), minRangeYear)
                        : props.minDate || minRangeYear;
                const maxYear =
                    props.maxDate && maxRangeYear != null
                        ? Math.min(props.maxDate.getFullYear(), maxRangeYear)
                        : props.maxDate || maxRangeYear;
        ...
        const setNavigationState = (newViewDate) => {
            ...
            const navPrev = DomHandler.findSingle(
                overlayRef.current,
                '[data-pc-section="previousbutton"]',
            );
            const navNext = DomHandler.findSingle(
                overlayRef.current,
            ...
            if (props.minDate) {
                const firstDayOfMonth = cloneDate(newViewDate);

                if (firstDayOfMonth.getMonth() === 0) {
                    firstDayOfMonth.setMonth(11, 1);
                    firstDayOfMonth.setFullYear(
            ...
            if (props.maxDate) {
                const lastDayOfMonth = cloneDate(newViewDate);
        ...
        const onDateCellKeydown = (event, date, groupIndex) => {
            ...
            switch (event.code) {
                case "ArrowDown": {
                    ...
                    if (nextRow) {
                        const tableRowIndex = DomHandler.index(
                            cell.parentElement,
                        );
                        ...
                        const hasNextFocusableDate = nextTableRows.find(
                            (el) => {
                                const focusCell =
                                    el.children[cellIndex].children[0];

                                return !DomHandler.getAttribute(
                                    focusCell,
                                    "data-p-disabled",
                                );
                            },
                ...
                case "ArrowUp": {
                    ...
                    if (event.altKey) {
                        ...
                        if (prevRow) {
                            ...
                            const hasNextFocusableDate = prevTableRows.find(
                                (el) => {
                                    const focusCell =
                                        el.children[cellIndex].children[0];
            ...
            if (prev) {
                if (props.numberOfMonths === 1 || groupIndex === 0) {
                    ...
                    const prevMonthContainer =
                        overlayRef.current.children[groupIndex - 1];
                    const cells = DomHandler.find(
                        prevMonthContainer,
                        'table td span:not([data-p-disabled="true"])',
                    );
                ...
                if (
                    ...
                    groupIndex === props.numberOfMonths - 1
                ) {
                    navigation.current = { backward: false };
                    navForward(event);
                } else {
        ...
        const onMonthCellKeydown = (event, index) => {
            ...
            switch (event.code) {
                ...
                case "ArrowDown": {
                    ...
                    const nextCell =
                        cells[
                            event.which === 40 ? cellIndex + 3 : cellIndex - 3
                        ];
        ...
        const onDateSelect = (event, dateMeta, timeMeta) => {
            ...
            if (isMultipleSelection()) {
                if (isSelected(dateMeta)) {
                    const value = props.value.filter((date, i) => {
                    ...
                    !props.maxDateCount ||
                    !props.value ||
                    props.maxDateCount > props.value.length
                ) {
            ...
            if (
                !props.inline &&
                isSingleSelection() &&
                (!props.showTime || props.hideOnDateTimeSelect)
            ) {
                setTimeout(() => {
                    hide("dateselect");
                }, 100);
        ...
        const enableModality = () => {
            if (!touchUIMask.current) {
                ...
                touchUIMask.current.style.zIndex = String(
                    ZIndexUtils.get(overlayRef.current) - 1,
                );
                !isUnstyled() &&
                ...
                touchUIMask.current.addEventListener(
                    "click",
                    touchUIMaskClickListener.current,
                );
        ...
        const destroyMask = () => {
            if (touchUIMask.current) {
                touchUIMask.current.removeEventListener(
                    "click",
                    touchUIMaskClickListener.current,
                );
        ...
        const isNavIconClicked = (target) => {
            return (
                (previousButton.current &&
                    (previousButton.current.isSameNode(target) ||
                        previousButton.current.contains(target))) ||
                (nextButton.current &&
                    (nextButton.current.isSameNode(target) ||
                        nextButton.current.contains(target)))
            );
        };
        ...
        const getFirstDayOfMonthIndex = (month, year) => {
            ...
            const dayIndex = day.getDay() + getSundayIndex();
        ...
        const isSelectableTime = (value) => {
            ...
            if (
                props.minDate &&
                props.minDate.toDateString() === value.toDateString()
            ) {
                if (props.minDate.getHours() > value.getHours()) {
                    ...
                    if (props.minDate.getMinutes() > value.getMinutes()) {
                        ...
                        props.minDate.getMinutes() === value.getMinutes()
                    ) {
                        if (props.minDate.getSeconds() > value.getSeconds()) {
                            validMin = false;
                        } else if (
                            props.minDate.getSeconds() === value.getSeconds()
                        ) {
                            if (
                                props.minDate.getMilliseconds() >
            ...
            if (
                props.maxDate &&
                props.maxDate.toDateString() === value.toDateString()
            ) {
                if (props.maxDate.getHours() < value.getHours()) {
                    ...
                    if (props.maxDate.getMinutes() < value.getMinutes()) {
                        ...
                        props.maxDate.getMinutes() === value.getMinutes()
                    ) {
                        if (props.maxDate.getSeconds() < value.getSeconds()) {
                            validMax = false;
                        } else if (
                            props.maxDate.getSeconds() === value.getSeconds()
                        ) {
                            if (
                                props.maxDate.getMilliseconds() <
                                value.getMilliseconds()
                ...
                if (isRangeSelection()) {
                    if (props.value[1])
                        return (
                            ...
                            isDateEquals(props.value[1], dateMeta) ||
                            isDateBetween(
                                props.value[0],
                                props.value[1],
                                dateMeta,
        ...
        const isMonthSelected = (month) => {
            if (isComparable()) {
                const value = isRangeSelection() ? props.value[0] : props.value;
        ...
        const isMonthYearDisabled = (month, year) => {
            const daysCountInAllMonth =
                month === -1
                    ? new Array(12)
                          .fill(0)
                          .map((_, i) => getDaysCountInMonth(i, year))
            ...
            for (let i = 0; i < daysCountInAllMonth.length; i++) {
                ...
                for (let day = 1; day <= monthDays; day++) {
                    const isDateSelectable = isSelectable(day, _month, year);
                ...
                try {
                    if (isSingleSelection()) {
                        ...
                        for (let i = 0; i < value.length; i++) {
                            ...
                            const dateAsString = isValidDate(selectedValue)
                                ? formatDateTime(selectedValue)
                                : "";
                        ...
                        if (value?.length) {
                            ...
                            formattedValue = isValidDate(startDate)
        ...
        const formatDate = (date, format) => {
            ...
            let output = "";
            let literal = false;
            const { dayNamesShort, dayNames, monthNamesShort, monthNames } =
        ...
        const populateTime = (value, timeString, ampm) => {
            ...
            const time = parseTime(timeString, ampm);
        ...
        const parseTime = (value, ampm) => {
            ...
            validTokenLength = props.showMillisec
                ? validTokenLength + 1
                : validTokenLength;
            ...
            const s = props.showSeconds ? parseInt(tokens[2], 10) : null;
        ...
        const isInMinYear = (viewDate) => {
            return (
                props.minDate &&
                props.minDate.getFullYear() === viewDate.getFullYear()
            );
        };
        ...
        const isInMaxYear = (viewDate) => {
            return (
                props.maxDate &&
                props.maxDate.getFullYear() === viewDate.getFullYear()
            );
        };
        ...
        useMountEffect(() => {
            const viewDate = getViewDate(props.viewDate);
        ...
        const createBackwardNavigator = (isVisible) => {
            ...
            const icon = props.prevIcon || (
                <ChevronLeftIcon {...previousIconProps} />
            );
            ...
            const { prevDecade, prevYear, prevMonth } = localeOptions(
                props.locale,
            );
        ...
        const createForwardNavigator = (isVisible) => {
            ...
            const icon = props.nextIcon || (
                <ChevronRightIcon {...nextIconProps} />
            );
            ...
            const { nextDecade, nextYear, nextMonth } = localeOptions(
                props.locale,
            );
        ...
        const renderMonthsNavigator = (index) => {
            return (
                props.monthNavigator &&
                props.view !== "month" &&
                (props.numberOfMonths === 1 || index === 0)
            );
        };
        ...
        const createTitleMonthElement = (month, monthIndex) => {
                ...
                const displayedMonthOptions = monthNames
                    .map((month, index) =>
                        (!isInMinYear(viewDate) ||
                            index >= props.minDate.getMonth()) &&
                        (!isInMaxYear(viewDate) ||
                            index <= props.maxDate.getMonth())
                            ? { label: month, value: index, index }
                            : null,
                    )
                    .filter((option) => !!option);
                const displayedMonthNames = displayedMonthOptions.map(
                    (option) => option.label,
                );
                const selectProps = mergeProps(
                    {
                        className: cx("select"),
                        onChange: (e) =>
                            onMonthDropdownChange(e, e.target.value),
                        value: viewMonth,
                    },
                    ptm("select"),
                );
            ...
            return (
                currentView === "date" && (
                    <button {...monthTitleProps}>{monthNames[month]}</button>
                )
            );
        };
        ...
        const createTitleYearElement = (metaYear) => {
            if (props.yearNavigator) {
                ...
                const displayedYearNames = yearOptions.filter(
                    (year) =>
                        !(
                            props.minDate && props.minDate.getFullYear() > year
                        ) &&
                        !(props.maxDate && props.maxDate.getFullYear() < year),
                );
                const selectProps = mergeProps(
                    {
                        className: cx("select"),
                        onChange: (e) =>
                            onYearDropdownChange(e, e.target.value),
                        value: viewYear,
                    },
                    ptm("select"),
                );
            ...
            const displayYear =
                props.numberOfMonths > 1 ? metaYear : currentYear;
            ...
            return (
                currentView !== "year" && (
                    <button {...yearTitleProps}>{displayYear}</button>
                )
            );
        };
        ...
        const createTitleDecadeElement = () => {
            ...
            if (currentView === "year") {
                ...
                return (
                    <span {...decadeTitleProps}>
                        {props.decadeTemplate ? (
                            props.decadeTemplate(years)
                        ) : (
                            <span {...decadeTitleTextProps}>{`${
                                yearPickerValues()[0]
                            } - ${
                                yearPickerValues()[
                                    yearPickerValues().length - 1
                                ]
                            }`}</span>
                        )}
                    </span>
        ...
        const createTitle = (monthMetaData, index) => {
            ...
            const showMonthAfterYear = localeOption(
                "showMonthAfterYear",
                props.locale,
            );
            ...
            if (props.showWeek) {
                ...
                const weekHeader = (
                    <th {...weekHeaderProps} key="wn">
                        <span {...weekLabel}>
                            {localeOption("weekHeader", props.locale)}
                        </span>
                    </th>
                );
        ...
        const createDateCellContent = (date, className, groupIndex) => {
            const content = props.dateTemplate
                ? props.dateTemplate(date)
                : date.day;
        ...
        const createWeek = (weekDates, weekNumber, groupIndex) => {
            const week = weekDates.map((date) => {
                ...
                const content =
                    date.otherMonth && !props.showOtherMonths
                        ? null
        ...
        const createMonth = (monthMetaData, index) => {
            ...
            const forwardNavigator = createForwardNavigator(
                props.numberOfMonths === 1 ||
                    index === props.numberOfMonths - 1,
            );
            const title = createTitle(monthMetaData, index);

            const dateViewGrid = createDateViewGrid(
                monthMetaData,
                weekDays,
                index,
            );
        ...
        const createDateView = () => {
            const viewDate = getViewDate();
            const monthsMetaData = createMonthsMeta(
                viewDate.getMonth(),
        ...
        const createMonthYearView = () => {
            ...
            const yearElement = createTitleYearElement(
                ...
                const incrementButtonProps = mergeProps(
                    {
                        ...
                        onMouseDown: (e) =>
                            onTimePickerElementMouseDown(e, 2, 1),
                        onMouseUp: onTimePickerElementMouseUp,
                        onMouseLeave: onTimePickerElementMouseLeave,
        ...
        const createMiliSecondPicker = () => {
            if (props.showMillisec) {
                const currentTime = getCurrentDateTime();
                const { nextMilliSecond, prevMilliSecond } = localeOptions(
                    props.locale,
                );
                ...
                const incrementButtonProps = mergeProps(
                    {
                        ...
                        onMouseDown: (e) =>
                            onTimePickerElementMouseDown(e, 3, 1),
                        onMouseUp: onTimePickerElementMouseUp,
                        onMouseLeave: onTimePickerElementMouseLeave,
        ...
        const createButtonBar = () => {
            if (props.showButtonBar) {
                ...
                const isHidden =
                    (props.minDate && props.minDate > nowDate) ||
                    (props.maxDate && props.maxDate < nowDate);
                    ...
                    <div {...buttonbarProps}>
                        <Button
                            ...
                            className={classNames(
                                props.todayButtonClassName,
                                cx("todayButton"),
                            )}
                            pt={ptm("todayButton")}
                            style={
                                isHidden ? { visibility: "hidden" } : undefined
                            }
                        />
                        <Button
                            type="button"
                            ...
                            const monthProps = mergeProps(
                                {
                                    ...
                                    onKeyDown: (event) =>
                                        onMonthCellKeydown(event, i),
                                    "data-p-disabled": isMonthYearDisabled(
                                        i,
                                        currentYear,
                                    ),
                                    "data-p-highlight": selected,
        ...
        const isFilled =
            DomHandler.hasClass(inputRef.current, "p-filled") &&
