...
const classes = {
    root: ({ props, focusedState, isFilled, panelVisible }) =>
        classNames("p-calendar p-component p-inputwrapper", {
            [`p-calendar-w-btn p-calendar-w-btn-${props.iconPos}`]:
                props.showIcon,
    ...
    year: ({ isYearSelected, y, isMonthYearDisabled }) =>
        classNames("p-yearpicker-year", {
            "p-highlight": isYearSelected(y),
            "p-disabled": isMonthYearDisabled(-1, y),
        }),
    monthPicker: "p-monthpicker",
    month: ({ isMonthSelected, isMonthYearDisabled, i, currentYear }) =>
        classNames("p-monthpicker-month", {
