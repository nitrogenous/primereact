    ...
    megamenu: {
        ...
        menu: ({ props, state }) => ({
            className: classNames(
                ...
                {
                    hidden:
                        props.orientation !== "vertical" && !state.mobileActive,
                },
                {
    ...
    image: {
        ...
        transition: {
            ...
            classNames: {
                ...
                exitActive:
                    "!opacity-0 !scale-75 transition-all duration-150 ease-in",
            },
        },
    },
    galleria: {
            ...
            className: classNames(
                ...
                "bg-white dark:bg-gray-900 text-gray-700 dark:text-white/80 p-5",
                {
                    "border border-solid border-gray-300 dark:border-blue-900/40 rounded-md":
                        props.__parentMetadata?.parent.props.__TYPE !==
                        "TreeSelect",
                },
            ),
        }),
                ...
                className: classNames(
                    ...
                    "dark:border-blue-900/40 dark:text-white/80 dark:bg-gray-900", //Dark Mode
                    {
                        ...
                        "flex-initial shrink-0":
                            context.scrollable && !context.frozen,
