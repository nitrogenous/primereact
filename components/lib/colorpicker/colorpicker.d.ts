...
export declare type ColorPickerPassThroughType<T> = PassThroughType<
    T,
...
export declare type ColorPickerPassThroughTransitionType =
    ...
    | ((
          options: ColorPickerPassThroughMethodOptions,
      ) => ReactCSSTransitionProps)
    | undefined;
...
export interface ColorPickerPassThroughOptions {
     ...
     */
    colorHandle?: ColorPickerPassThroughType<
     ...
     */
    hueHandle?: ColorPickerPassThroughType<
        React.HTMLAttributes<HTMLDivElement>
    >;
    /**
...
interface ColorPickerChangeEvent
    extends FormEvent<string | ColorPickerRGBType | ColorPickerHSBType> {}
 ...
 * @group Component
 */
export declare class ColorPicker extends React.Component<
    ColorPickerProps,
    any
> {
    /**
