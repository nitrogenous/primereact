...
const classes = {
	root: ({ props }) =>
		classNames(`p-fileupload p-fileupload-${props.mode} p-component`),
	...
	basicButton: ({ disabled, focusedState, hasFiles }) =>
		classNames("p-button p-component p-fileupload-choose", {
			"p-fileupload-choose-selected": hasFiles,
			"p-disabled": disabled,
			"p-focus": focusedState,
		}),
	chooseIcon: ({ props, iconOnly }) =>
		props.mode === "basic"
			? classNames("p-button-icon", { "p-button-icon-left": !iconOnly })
			: classNames("p-button-icon p-clickable", {
					"p-button-icon-left": !iconOnly,
			  }),
	uploadIcon: ({ iconOnly }) =>
		classNames("p-button-icon p-c", { "p-button-icon-left": !iconOnly }),
	cancelIcon: ({ iconOnly }) =>
		classNames("p-button-icon p-c", { "p-button-icon-left": !iconOnly }),
};
