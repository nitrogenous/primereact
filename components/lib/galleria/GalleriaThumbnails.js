...
export const GalleriaThumbnails = React.memo(
    React.forwardRef((props, ref) => {
        ...
        const step = (dir) => {
            ...
            if (
                dir < 0 &&
                -1 * totalShiftedItems + numVisibleState >
            ...
            if (props.circular) {
                if (
                    dir < 0 &&
                    props.value.length - 1 === props.activeItemIndex
                ) {
                    totalShiftedItems = 0;
        ...
        useMountEffect(() => {
            if (itemsContainerRef.current) {
                ...
                itemsContainerRef.current.setAttribute(
                    attributeSelector.current,
                    "",
                );
            }
        ...
        useUpdateEffect(() => {
            ...
            if (
                ...
                if (props.activeItemIndex <= getMedianItemIndex()) {
                    ...
                    totalShiftedItems =
                        props.activeItemIndex * -1 + getMedianItemIndex();
                }
