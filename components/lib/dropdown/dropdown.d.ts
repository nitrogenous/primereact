...
export declare type DropdownPassThroughType<T> = PassThroughType<
    T,
...
export interface DropdownPassThroughOptions {
     ...
     */
    clearIcon?: DropdownPassThroughType<
     ...
     */
    hiddenSelectedMessage?: DropdownPassThroughType<
        React.HTMLAttributes<HTMLDivElement>
    >;
    /**
