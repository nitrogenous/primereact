...
export declare type MessagesPassThroughType<T> = PassThroughType<
	T,
	MessagesPassThroughMethodOptions
>;
export declare type MessagesPassThroughTransitionType =
	| ReactCSSTransitionProps
	| ((options: MessagesPassThroughMethodOptions) => ReactCSSTransitionProps)
	| undefined;
...
export interface MessagesPassThroughOptions {
	 ...
	 */
	buttonIcon?: MessagesPassThroughType<
		React.SVGProps<SVGSVGElement> | React.HTMLAttributes<HTMLSpanElement>
	>;
	/**
