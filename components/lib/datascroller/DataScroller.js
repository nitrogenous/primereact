...
export const DataScroller = React.memo(
    React.forwardRef((inProps, ref) => {
        ...
        const bindScrollListener = () => {
            if (props.inline) {
                scrollFunction.current = () => {
                    ...
                    if (
                        scrollTop >=
                        scrollHeight * props.buffer - viewportHeight
                    ) {
                        load();
                    }
                };
        ...
        const createContent = () => {
            ...
            const content = ObjectUtils.isNotEmpty(dataToRenderState)
                ? dataToRenderState.map(createItem)
                : createEmptyMessage();
