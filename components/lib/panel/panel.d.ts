...
export declare type PanelPassThroughType<T> = PassThroughType<
    T,
    PanelPassThroughMethodOptions
>;
export declare type PanelPassThroughTransitionType =
    | ReactCSSTransitionProps
    | ((options: PanelPassThroughMethodOptions) => ReactCSSTransitionProps)
    | undefined;
...
export interface PanelPassThroughOptions {
     ...
     */
    togglerIcon?: PanelPassThroughType<
     ...
     */
    toggleableContent?: PanelPassThroughType<
...
export interface PanelProps
    ...
    headerTemplate?:
        | React.ReactNode
        | ((options: PanelHeaderTemplateOptions) => React.ReactNode);
    /**
    ...
    footerTemplate?:
        | React.ReactNode
        | ((options: PanelFooterTemplateOptions) => React.ReactNode);
    /**
