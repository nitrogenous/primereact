...
export declare type TabViewPassThroughType<T> = PassThroughType<
    T,
    TabViewPassThroughMethodOptions
>;
export declare type TabPanelPassThroughType<T> = PassThroughType<
    T,
...
export interface TabPanelPassThroughOptions {
     ...
     */
    headerAction?: TabPanelPassThroughType<
        React.HTMLAttributes<HTMLAnchorElement>
    >;
    /**
     * Uses to pass attributes to the title's DOM element.
     */
    headerTitle?: TabPanelPassThroughType<
...
export interface TabPanelProps {
    ...
    headerTemplate?:
        | React.ReactNode
        | ((options: TabPanelHeaderTemplateOptions) => React.ReactNode);
    /**
...
export interface TabViewPassThroughOptions {
     ...
     */
    previousButton?: TabViewPassThroughType<
        React.HTMLAttributes<HTMLButtonElement>
    >;
    /**
     * Uses to pass attributes to the previous button icon's DOM element.
     */
    previousIcon?: TabViewPassThroughType<
     ...
     */
    nextButton?: TabViewPassThroughType<
        React.HTMLAttributes<HTMLButtonElement>
    >;
    /**
     * Uses to pass attributes to the next button icon's DOM element.
     */
    nextIcon?: TabViewPassThroughType<
        React.SVGProps<SVGSVGElement> | React.HTMLAttributes<HTMLSpanElement>
    >;
    /**
     * Uses to pass attributes to the panel's DOM element.
     */
    panelContainer?: TabViewPassThroughType<
