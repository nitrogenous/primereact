...
export declare type ContextMenuPassThroughType<T> = PassThroughType<
    T,
    ContextMenuPassThroughMethodOptions
>;
export declare type ContextMenuPassThroughTransitionType =
    | ReactCSSTransitionProps
    | ((
          options: ContextMenuPassThroughMethodOptions,
      ) => ReactCSSTransitionProps)
    | undefined;
...
export interface ContextMenuPassThroughOptions {
     ...
     */
    action?: ContextMenuPassThroughType<
        React.HTMLAttributes<HTMLAnchorElement>
    >;
    /**
     * Uses to pass attributes to the icon's DOM element.
     */
    icon?: ContextMenuPassThroughType<
     ...
     */
    submenuIcon?: ContextMenuPassThroughType<
        React.SVGProps<SVGSVGElement> | React.HTMLAttributes<HTMLSpanElement>
    >;
    /**
