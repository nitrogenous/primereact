...
export declare type InputTextareaPassThroughType<T> = PassThroughType<
    T,
...
export interface InputTextareaPassThroughOptions {
     ...
     */
    root?: InputTextareaPassThroughType<
 ...
 * @group Component
 */
export declare const InputTextarea: React.ForwardRefExoticComponent<
