...
export declare type TriStateCheckboxPassThroughType<T> = PassThroughType<
    T,
...
export interface TriStateCheckboxPassThroughOptions {
     ...
     */
    root?: TriStateCheckboxPassThroughType<
        React.HTMLAttributes<HTMLDivElement>
    >;
    /**
     * Uses to pass attributes to the checkbox box's DOM element.
     */
    checkbox?: TriStateCheckboxPassThroughType<
        React.HTMLAttributes<HTMLDivElement>
    >;
    /**
     ...
     */
    checkIcon?: TriStateCheckboxPassThroughType<
     ...
     */
    uncheckIcon?: TriStateCheckboxPassThroughType<
        React.SVGProps<SVGSVGElement> | React.HTMLAttributes<HTMLSpanElement>
    >;
    /**
     * Uses to pass attributes to the sr only aria's DOM element.
     */
    srOnlyAria?: TriStateCheckboxPassThroughType<
 ...
 * @group Component
 */
export declare class TriStateCheckbox extends React.Component<
