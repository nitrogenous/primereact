...
export declare type PanelMenuPassThroughType<T> = PassThroughType<
    T,
    PanelMenuPassThroughMethodOptions
>;
export declare type PanelMenuPassThroughTransitionType =
    | ReactCSSTransitionProps
    | ((options: PanelMenuPassThroughMethodOptions) => ReactCSSTransitionProps)
    | undefined;
...
export interface PanelMenuPassThroughOptions {
     ...
     */
    headerAction?: PanelMenuPassThroughType<
        React.HTMLAttributes<HTMLAnchorElement>
    >;
    /**
     * Uses to pass attributes to the submenuIcon's DOM element.
     */
    submenuIcon?: PanelMenuPassThroughType<
