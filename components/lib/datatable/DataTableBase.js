...
const classes = {
	...
	filterRowItem: ({ isRowMatchModeSelected, isShowMatchModes, value }) =>
		isShowMatchModes()
			? classNames("p-column-filter-row-item", {
	...
	filterOverlay: ({ columnFilterProps: props, context, getColumnProp }) =>
		classNames(
			...
			getColumnProp("filterMenuClassName"),
			{
	...
	checkboxWrapper: ({ rowProps: props, focusedState }) =>
		classNames("p-checkbox p-component", {
			"p-checkbox-focused": focusedState,
			"p-disabled": props.disabled,
		}),
	checkbox: ({ rowProps: props, focusedState }) =>
		classNames("p-checkbox-box p-component", {
			"p-highlight": props.checked,
			"p-focus": focusedState,
		}),
	checkboxIcon: "p-checkbox-icon",
	radiobuttonWrapper: ({ rowProps: props, focusedState }) =>
		classNames("p-radiobutton p-component", {
			"p-radiobutton-focused": focusedState,
			"p-disabled": props.disabled,
		}),
	radiobutton: ({ rowProps: props, focusedState }) =>
		classNames("p-radiobutton-box p-component", {
			"p-highlight": props.checked,
			"p-focus": focusedState,
		}),
	...
	headerCell: ({
		...
		ObjectUtils.isEmpty(props)
			...
			: classNames({
					"p-filter-column":
						!props.headerColumnGroup && props.filterDisplay === "row",
					...
					"p-reorderable-column":
						props.reorderableColumns && getColumnProp("reorderable") && !frozen,
					[`p-align-${align}`]: !!align,
			  }),
