...
type DataTableHeaderTemplateType<TValue extends DataTableValueArray> =
    | React.ReactNode
    | ((options: DataTableHeaderTemplateOptions<TValue>) => React.ReactNode);

type DataTableFooterTemplateType<TValue extends DataTableValueArray> =
    | React.ReactNode
    | ((options: DataTableFooterTemplateOptions<TValue>) => React.ReactNode);

type DataTableRowGroupHeaderTemplateType<TValue extends DataTableValueArray> =
    | React.ReactNode
    | ((
          data: any,
...
type DataTableRowGroupFooterTemplateType<TValue extends DataTableValueArray> =
    | React.ReactNode
    | ((
          data: any,
...
interface DataTableFooterTemplateOptions<TValue extends DataTableValueArray>
    extends DataTableHeaderTemplateOptions<TValue> {}
 ...
 */
interface DataTableRowGroupFooterTemplateOptions<T extends DataTableValueArray>
    extends DataTableRowGroupHeaderTemplateOptions<T> {
    /**
 ...
 * @event
 */
interface DataTableContextMenuSingleSelectionChangeEvent<
    TValue extends DataTableValueArray,
> {
    /**
     * Browser event.
 ...
 * @event
 */
interface DataTableContextMenuMultipleSelectionChangeEvent<
    TValue extends DataTableValueArray,
> {
    /**
     * Browser event.
 ...
 * @event
 */
interface DataTableSelectionMultipleChangeEvent<
    TValue extends DataTableValueArray,
> {
    /**
     * Browser event.
 ...
 * @event
 */
interface DataTableSelectionSingleChangeEvent<
    TValue extends DataTableValueArray,
> {
    /**
     * Browser event.
 ...
 * @event
 */
interface DataTableSelectionCellChangeEvent<
    TValue extends DataTableValueArray,
> {
    /**
     * Browser event.
 ...
 */
interface DataTableRowMouseEvent
    extends Omit<DataTableRowEvent, "originalEvent"> {
    /**
     * Browser event.
     */
    originalEvent: React.MouseEvent<HTMLElement>;
 ...
 * @event
 */
interface DataTableRowPointerEvent
    extends Omit<DataTableRowEvent, "originalEvent"> {
    /**
     * Browser event.
     */
...
type DataTableRowData<TValueArray extends DataTableValueArray> =
    TValueArray extends Array<infer TValue> ? TValue : never;

type DataTableRowDataArray<TValue extends DataTableValueArray> =
...
export declare type DataTablePassThroughType<T> = PassThroughType<
    T,
...
export interface DataTablePassThroughOptions {
     ...
     */
    loadingOverlay?: DataTablePassThroughType<
        React.HTMLAttributes<HTMLDivElement>
    >;
    /**
     * Uses to pass attributes to the loading icon's DOM element.
     */
    loadingIcon?: DataTablePassThroughType<
     ...
     */
    virtualScrollerSpacer?: DataTablePassThroughType<
     ...
     */
    reorderIndicatorDownIcon?: DataTablePassThroughType<
        React.SVGProps<SVGSVGElement> | React.HTMLAttributes<HTMLSpanElement>
    >;
    /**
 ...
 */
interface DataTableBaseProps<TValue extends DataTableValueArray>
    extends Omit<
    ...
    rowGroupFooterTemplate?:
        | DataTableRowGroupFooterTemplateType<TValue>
        | undefined;
    /**
     * Function to provide the content of row group header.
     */
    rowGroupHeaderTemplate?:
        | DataTableRowGroupHeaderTemplateType<TValue>
        | undefined;
    /**
 ...
 * @group Properties
 */
interface DataTablePropsSingle<TValue extends DataTableValueArray>
    ...
    onContextMenuSelectionChange?(
        event: DataTableContextMenuSingleSelectionChangeEvent<TValue>,
    ): void;
    /**
     ...
     */
    onSelectionChange?(
        event: DataTableSelectionSingleChangeEvent<TValue>,
    ): void;
}
 ...
 * @group Properties
 */
interface DataTablePropsMultiple<TValue extends DataTableValueArray>
    extends DataTableBaseProps<TValue> {
    /**
     * Whether to cell selection is enabled or not.
     * @defaultValue false
     ...
     */
    onContextMenuSelectionChange?(
        event: DataTableContextMenuMultipleSelectionChangeEvent<TValue>,
    ): void;
    /**
     * Callback to invoke when selection changes.
     ...
     */
    onSelectionChange?(
        event: DataTableSelectionMultipleChangeEvent<TValue>,
    ): void;
}
 ...
 * @group Properties
 */
interface DataTablePropsCell<TValue extends DataTableValueArray>
    extends DataTableBaseProps<TValue> {
    /**
     * Whether to cell selection is enabled or not.
     * @defaultValue false
...
export declare class DataTable<
    TValue extends DataTableValueArray,
> extends React.Component<DataTableProps<TValue>, any> {
    /**
