...
export const BodyCell = React.memo((props) => {
    ...
    const equals = (selectedCell) => {
        return (
            ...
            (selectedCell.field === field ||
                selectedCell.cellIndex === props.index)
        );
    };
    ...
    const onClick = (event) => {
        ...
        if (
            ...
            const cellEditValidatorEvent = getColumnProp(
    ...
    const createLoading = () => {
        const options = getVirtualScrollerOption("getLoaderOptions")(
            props.rowIndex,
            {
                ...
                cellLast:
                    props.index ===
                    getVirtualScrollerOption("columns").length - 1,
    ...
    const createElement = () => {
        ...
        if (selectionMode) {
            ...
            const icon = props.expanded
                ? props.expandedRowIcon || (
                      <ChevronDownIcon {...rowTogglerIconProps} />
                  )
            ...
            const rowEditorSaveIcon = IconUtils.getJSXIcon(
                props.rowEditorSaveIcon || (
                    <CheckIcon {...rowEditorSaveIconProps} />
                ),
            ...
            const rowEditorInitIcon = IconUtils.getJSXIcon(
                props.rowEditorInitIcon || (
                    <PencilIcon {...rowEditorInitIconProps} />
                ),
        ...
        const bodyCellProps = mergeProps(
            {
                ...
                "data-p-selection-column":
                    getColumnProp("selectionMode") != null,
