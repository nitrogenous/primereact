...
export declare type SidebarPassThroughType<T> = PassThroughType<
    T,
    SidebarPassThroughMethodOptions
>;
export declare type SidebarPassThroughTransitionType =
    | ReactCSSTransitionProps
    | ((options: SidebarPassThroughMethodOptions) => ReactCSSTransitionProps)
    | undefined;
...
export interface SidebarPassThroughOptions {
     ...
     */
    closeButtonIcon?: SidebarPassThroughType<
