...
export const Dock = React.memo(
    React.forwardRef((inProps, ref) => {
        ...
        const findNextOptionIndex = (index) => {
            const menuitems = DomHandler.find(
                listRef.current,
                'li[data-pc-section="menuitem"][data-p-disabled="false"]',
            );
            const matchedOptionIndex = [...menuitems].findIndex(
                (link) => link.id === index,
            );
        ...
        const createHeader = () => {
            if (props.header) {
                const header = ObjectUtils.getJSXElement(props.header, {
                    props,
                });
        ...
        const createFooter = () => {
            if (props.footer) {
                const footer = ObjectUtils.getJSXElement(props.footer, {
                    props,
                });
