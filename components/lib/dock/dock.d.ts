...
export declare type DockPassThroughType<T> = PassThroughType<
    T,
...
export interface DockProps
    ...
    header?:
        | React.ReactNode
        | ((options: DockHeaderTemplateOptions) => React.ReactNode);
    /**
     * Template of footer element.
     */
    footer?:
        | React.ReactNode
        | ((options: DockFooterTemplateOptions) => React.ReactNode);
    /**
