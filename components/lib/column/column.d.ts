...
export declare type ColumnPassThroughType<T> = PassThroughType<
    T,
...
export interface ColumnPassThroughOptions {
     ...
     */
    headerCell?: ColumnPassThroughType<
        React.HTMLAttributes<HTMLTableCellElement>
    >;
    /**
     * Uses to pass attributes to the column resizer's DOM element.
     */
    columnResizer?: ColumnPassThroughType<
     ...
     * Uses to pass attributes to the sort's DOM element.
     */
    sortIcon?: ColumnPassThroughType<
     ...
     */
    filterRowItems?: ColumnPassThroughType<
     ...
     */
    filterSeparator?: ColumnPassThroughType<
        React.HTMLAttributes<HTMLLIElement>
    >;
    /**
     * Uses to pass attributes to the filter operator's DOM element.
     */
    filterOperator?: ColumnPassThroughType<
        React.HTMLAttributes<HTMLDivElement>
    >;
    /**
     ...
     */
    filterConstraints?: ColumnPassThroughType<
        React.HTMLAttributes<HTMLDivElement>
    >;
    /**
     * Uses to pass attributes to the filter constraint's DOM element.
     */
    filterConstraint?: ColumnPassThroughType<
        React.HTMLAttributes<HTMLDivElement>
    >;
    /**
     * Uses to pass attributes to the Dropdown component.
     ...
     */
    filterButtonbar?: ColumnPassThroughType<
        React.HTMLAttributes<HTMLDivElement>
    >;
    /**
     * Uses to pass attributes to the Button component.
     ...
     */
    radiobuttonWrapper?: ColumnPassThroughType<
        React.HTMLAttributes<HTMLDivElement>
    >;
    /**
     ...
     */
    radiobuttonIcon?: ColumnPassThroughType<
        React.HTMLAttributes<HTMLDivElement>
    >;
    /**
     * Uses to pass attributes to the checkbox wrapper's DOM element.
     */
    checkboxWrapper?: ColumnPassThroughType<
        React.HTMLAttributes<HTMLDivElement>
    >;
    /**
     ...
     */
    checkboxIcon?: ColumnPassThroughType<
        React.SVGProps<SVGSVGElement> | React.HTMLAttributes<HTMLSpanElement>
    >;
    /**
 ...
 */
interface ColumnFilterHeaderTemplateOptions
    extends ColumnFilterApplyTemplateOptions {}
 ...
 * @extends {ColumnFilterApplyTemplateOptions}
 */
interface ColumnFilterFooterTemplateOptions
    extends ColumnFilterApplyTemplateOptions {}
 ...
 * @event
 */
interface ColumnFilterConstraintRemoveEvent
    extends ColumnFilterConstraintAddEvent {}
...
export interface ColumnProps {
    ...
    bodyClassName?:
        | string
        | ((data: any, options: ColumnBodyOptions) => string);
    /**
    ...
    filterFooter?:
        | React.ReactNode
        | ((options: ColumnFilterFooterTemplateOptions) => React.ReactNode);
    /**
     * Template of header element in menu.
     */
    filterHeader?:
        | React.ReactNode
        | ((options: ColumnFilterHeaderTemplateOptions) => React.ReactNode);
    /**
    ...
    footer?:
        | React.ReactNode
        | ((options: ColumnFooterOptions) => React.ReactNode);
    /**
    ...
    header?:
        | React.ReactNode
        | ((options: ColumnHeaderOptions) => React.ReactNode);
    /**
