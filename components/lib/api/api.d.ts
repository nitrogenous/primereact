...
export interface APIOptions {
     ...
     */
    setFilterMatchModeOptions?: Dispatch<
        SetStateAction<FilterMatchModeOptions>
    >;
    /**
 ...
 */
export declare function locale(locale: string): {
    locale: string;
    options: object;
};
/**
 ...
 * @param {string} locale - Locale string.
 */
export declare function updateLocaleOption(
    key: string,
    value: any,
    locale: string,
): void;
 ...
 * @param {string} locale - Locale string.
 */
export declare function updateLocaleOptions(
    options: object,
    locale: string,
): void;
/**
