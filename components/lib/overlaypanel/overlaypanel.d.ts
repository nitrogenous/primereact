...
export declare type OverlayPanelPassThroughType<T> = PassThroughType<
	T,
	OverlayPanelPassThroughMethodOptions
>;
export declare type OverlayPanelPassThroughTransitionType =
	| ReactCSSTransitionProps
	| ((options: OverlayPanelPassThroughMethodOptions) => ReactCSSTransitionProps)
	| undefined;
...
export interface OverlayPanelPassThroughOptions {
	 ...
	 */
	closeButton?: OverlayPanelPassThroughType<
 ...
 * @group Component
 */
export declare class OverlayPanel extends React.Component<
	OverlayPanelProps,
	any
> {
	/**
