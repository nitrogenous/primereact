				...
				return (
					<div {...toolbarProps}>
						<span {...formatsProps}>
							...
							>
								<option {...getMergeProps({ value: "1" }, "option")}>
									Heading
								</option>
								<option {...getMergeProps({ value: "2" }, "option")}>
									Subheading
								</option>
								<option {...getMergeProps({ value: "0" }, "option")}>
									Normal
								</option>
							</select>
							<select {...getMergeProps({ className: "ql-font" }, "font")}>
								...
								<option
									{...getMergeProps({ value: "serif" }, "option")}
								></option>
								<option
									{...getMergeProps({ value: "monospace" }, "option")}
								></option>
							</select>
						</span>
						<span {...formatsProps}>
						...
						<span {...formatsProps}>
							<select
								{...getMergeProps({ className: "ql-color" }, "color")}
							></select>
							<select
								{...getMergeProps({ className: "ql-background" }, "background")}
							></select>
						</span>
						<span {...formatsProps}>
							<button
							...
							<select {...getMergeProps({ className: "ql-align" }, "select")}>
								<option
									{...getMergeProps({ defaultValue: true }, "option")}
								></option>
								<option
									{...getMergeProps({ value: "center" }, "option")}
								></option>
								<option
									{...getMergeProps({ value: "right" }, "option")}
								></option>
								<option
									{...getMergeProps({ value: "justify" }, "option")}
								></option>
							</select>
						</span>
						<span {...formatsProps}>
