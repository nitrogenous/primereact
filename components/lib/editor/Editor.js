            ...
            return (
                <div {...toolbarProps}>
                    <span {...formatsProps}>
                        ...
                        >
                            <option
                                {...getMergeProps({ value: "1" }, "option")}
                            >
                                Heading
                            </option>
                            <option
                                {...getMergeProps({ value: "2" }, "option")}
                            >
                                Subheading
                            </option>
                            <option
                                {...getMergeProps({ value: "0" }, "option")}
                            >
                                Normal
                            </option>
                        </select>
                        <select
                            {...getMergeProps({ className: "ql-font" }, "font")}
                        >
