...
export const LastPageLink = React.memo((inProps) => {
	...
	const className = classNames("p-paginator-last p-paginator-element p-link", {
	...
	const icon = props.lastPageLinkIcon || (
		<AngleDoubleRightIcon {...lastPageIconProps} />
	);
	const lastPageLinkIcon = IconUtils.getJSXIcon(
		icon,
		{ ...lastPageIconProps },
		{ props },
	);
