...
export declare type PaginatorPassThroughType<T> = PassThroughType<
	T,
	PaginatorPassThroughMethodOptions
>;
export declare type PaginatorPassThroughTransitionType =
	| ReactCSSTransitionProps
	| ((options: PaginatorPassThroughMethodOptions) => ReactCSSTransitionProps)
	| undefined;
...
export interface PaginatorPassThroughOptions {
	 ...
	 */
	firstPageButton?: PaginatorPassThroughType<
		React.HTMLAttributes<HTMLButtonElement>
	>;
	/**
	 * Uses to pass attributes to the first page icon's DOM element.
	 */
	firstPageIcon?: PaginatorPassThroughType<
	 ...
	 */
	pageButton?: PaginatorPassThroughType<
		React.HTMLAttributes<HTMLButtonElement>
	>;
	/**
...
interface PaginatorTemplateOptions {
	...
	FirstPageLink?:
		| React.ReactNode
		| ((options: PaginatorFirstPageLinkOptions) => React.ReactNode);
	/**
	 * The prev page link component.
	 */
	PrevPageLink?:
		| React.ReactNode
		| ((options: PaginatorPrevPageLinkOptions) => React.ReactNode);
	/**
	 * The page links component.
	 */
	PageLinks?:
		| React.ReactNode
		| ((options: PaginatorPageLinksOptions) => React.ReactNode);
	/**
	 * The next page link component.
	 */
	NextPageLink?:
		| React.ReactNode
		| ((options: PaginatorNextPageLinkOptions) => React.ReactNode);
	/**
	 * The last page link component.
	 */
	LastPageLink?:
		| React.ReactNode
		| ((options: PaginatorLastPageLinkOptions) => React.ReactNode);
	/**
	 * The rows per page dropdown component.
	 */
	RowsPerPageDropdown?:
		| React.ReactNode
		| ((options: PaginatorRowsPerPageDropdownOptions) => React.ReactNode);
	/**
	 * The current page report component.
	 */
	CurrentPageReport?:
		| React.ReactNode
		| ((options: PaginatorCurrentPageReportOptions) => React.ReactNode);
	/**
	 * The jump to page input component.
	 */
	JumpToPageInput?:
		| React.ReactNode
		| ((options: PaginatorJumpToPageInputOptions) => React.ReactNode);
}
