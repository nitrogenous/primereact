...
export const FirstPageLink = React.memo((inProps) => {
	...
	const className = classNames("p-paginator-first p-paginator-element p-link", {
	...
	const icon = props.firstPageLinkIcon || (
		<AngleDoubleLeftIcon {...firstPageIconProps} />
	);
	const firstPageLinkIcon = IconUtils.getJSXIcon(
		icon,
		{ ...firstPageIconProps },
		{ props },
	);
