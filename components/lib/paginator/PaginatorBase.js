...
const classes = {
	...
	firstPageButton: ({ disabled }) =>
		classNames("p-paginator-first p-paginator-element p-link", {
			"p-disabled": disabled,
		}),
	prevPageIcon: "p-paginator-icon",
	prevPageButton: ({ disabled }) =>
		classNames("p-paginator-prev p-paginator-element p-link", {
			"p-disabled": disabled,
		}),
	nextPageIcon: "p-paginator-icon",
	nextPageButton: ({ disabled }) =>
		classNames("p-paginator-next p-paginator-element p-link", {
			"p-disabled": disabled,
		}),
	lastPageIcon: "p-paginator-icon",
	lastPageButton: ({ disabled }) =>
		classNames("p-paginator-last p-paginator-element p-link", {
			"p-disabled": disabled,
		}),
