...
const classes = {
	...
	table: ({ props }) =>
		classNames("p-treetable-table", {
			...
			"p-treetable-resizable-table-fit":
				props.resizableColumns && props.columnResizeMode === "fit",
		}),
	...
	headerCell: ({
		...
		options.filterOnly
			...
			: classNames({
					...
					"p-resizable-column":
						props.resizableColumns && getColumnProp(column, "resizeable"),
					"p-reorderable-column":
						props.reorderableColumns &&
						getColumnProp(column, "reorderable") &&
						!frozen,
					[`p-align-${align}`]: !!align,
			  }),
	...
	row: ({ isSelected, rowProps: props }) => ({
		...
		"p-highlight-contextmenu":
			...
			props.contextMenuSelectionKey === props.node.key,
		"p-row-odd": props.rowIndex % 2 !== 0,
	}),
	checkboxWrapper: "p-checkbox p-treetable-checkbox p-component",
	checkbox: ({ checked, partialChecked }) =>
	...
	scrollable: ({ scrolaableProps: props }) =>
		classNames("p-treetable-scrollable-view", {
