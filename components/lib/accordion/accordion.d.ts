...
export declare type AccordionPassThroughType<T> = PassThroughType<
	T,
	AccordionPassThroughMethodOptions
>;
export declare type AccordionTabPassThroughType<T> = PassThroughType<
	T,
	AccordionTabPassThroughMethodOptions
>;
export declare type AccordionPassThroughTransitionType =
	| ReactCSSTransitionProps
	| ((options: AccordionPassThroughMethodOptions) => ReactCSSTransitionProps)
	| undefined;
...
export interface AccordionTabPassThroughOptions {
	 ...
	 */
	headerAction?: AccordionTabPassThroughType<
		React.HTMLAttributes<HTMLAnchorElement>
	>;
	/**
	 * Uses to pass attributes to the headericon's DOM element.
	 */
	headerIcon?: AccordionTabPassThroughType<
	 ...
	 */
	headerTitle?: AccordionTabPassThroughType<
		React.HTMLAttributes<HTMLSpanElement>
	>;
	/**
	 * Uses to pass attributes to the toggleablecontent's DOM element.
	 */
	toggleableContent?: AccordionTabPassThroughType<
...
interface AccordionTabProps {
	...
	header?:
		| React.ReactNode
		| ((props: AccordionTabProps) => React.ReactNode)
		| undefined;
	/**
 ...
 * @group Component
 */
export declare class AccordionTab extends React.Component<
	AccordionTabProps,
	any
> {}
