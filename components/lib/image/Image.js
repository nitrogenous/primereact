...
export const Image = React.memo(
    React.forwardRef((inProps, ref) => {
        ...
        const [previewVisibleState, setPreviewVisibleState] =
        ...
        const onMaskClick = (event) => {
            const isActionbarTarget =
                [event.target.classList].includes("p-image-action") ||
                event.target.closest(".p-image-action");
        ...
        const createPreview = () => {
            const ariaLabel = localeOption("aria")
                ? localeOption("aria").zoomImage
                : undefined;
        ...
        const createElement = () => {
            ...
            const downloadIcon = IconUtils.getJSXIcon(
                props.downloadIcon || <DownloadIcon />,
                { ...downloadIconProps },
                { props },
            );
            const rotateRightIcon = IconUtils.getJSXIcon(
                props.rotateRightIcon || <RefreshIcon />,
                { ...rotateRightIconProps },
                { props },
            );
            const rotateLeftIcon = IconUtils.getJSXIcon(
                props.rotateLeftIcon || <UndoIcon />,
                { ...rotateLeftIconProps },
                { props },
            );
            const zoomOutIcon = IconUtils.getJSXIcon(
                props.zoomOutIcon || <SearchMinusIcon />,
                { ...zoomOutIconProps },
                { props },
            );
            const zoomInIcon = IconUtils.getJSXIcon(
                props.zoomInIcon || <SearchPlusIcon />,
                { ...zoomInIconProps },
                { props },
            );
            const closeIcon = IconUtils.getJSXIcon(
                props.closeIcon || <TimesIcon />,
                { ...closeIconProps },
                { props },
            );
            ...
            return (
                <div {...maskProps}>
                    <div {...toolbarProps}>
                        ...
                        <button {...rotateRightButtonProps}>
                            {rotateRightIcon}
                        </button>
                        <button {...rotateLeftButtonProps}>
                            {rotateLeftIcon}
                        </button>
        ...
        const indicatorIcon = IconUtils.getJSXIcon(
            icon,
            { ...iconProp },
            { props },
        );
        ...
        return (
            <span {...rootProps}>
                ...
                {preview}
                {maskVisibleState && (
                    <Portal element={element} appendTo={document.body} />
                )}
            </span>
        );
    }),
