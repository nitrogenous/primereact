...
export declare type InputNumberPassThroughType<T> = PassThroughType<
    T,
 ...
 * @group Component
 */
export declare class InputNumber extends React.Component<
    InputNumberProps,
    any
> {
    /**
