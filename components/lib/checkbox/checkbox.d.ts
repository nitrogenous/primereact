...
export declare type CheckboxPassThroughType<T> = PassThroughType<
    T,
...
export interface CheckboxPassThroughOptions {
     ...
     */
    hiddenInputWrapper?: CheckboxPassThroughType<
        React.HTMLAttributes<HTMLDivElement>
    >;
    /**
     * Uses to pass attributes to the hidden input's DOM element.
     */
    hiddenInput?: CheckboxPassThroughType<
