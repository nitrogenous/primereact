...
export declare type PickListPassThroughType<T> = PassThroughType<
    T,
...
export interface PickListPassThroughOptions {
     ...
     * Uses to pass attributes to the buttons' DOM element.
     */
    filterIcon?: PickListPassThroughType<
     ...
     * Uses to pass attributes to the buttons' DOM element.
     */
    filterInput?: PickListPassThroughType<
        React.HTMLAttributes<HTMLInputElement>
    >;
    /**
     * Uses to pass attributes to the buttons' DOM element.
     */
    filterContainer?: PickListPassThroughType<
...
export interface PickListProps {
    ...
    sourceFilterTemplate?:
        | React.ReactNode
        | ((options: PickListFilterTemplateOptions) => React.ReactNode)
        | undefined;
    /**
     * Placeholder text on target filter input.
     */
