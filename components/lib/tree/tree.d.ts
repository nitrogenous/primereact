...
export declare type TreePassThroughType<T> = PassThroughType<
    T,
...
export interface TreePassThroughOptions {
     ...
     */
    loadingIcon?: TreePassThroughType<
     ...
     */
    searchIcon?: TreePassThroughType<
        React.SVGProps<SVGSVGElement> | React.HTMLAttributes<HTMLSpanElement>
    >;
    /**
     ...
     */
    checkboxContainer?: TreePassThroughType<
     ...
     */
    checkboxIcon?: TreePassThroughType<
        React.SVGProps<SVGSVGElement> | React.HTMLAttributes<HTMLSpanElement>
    >;
    /**
     * Uses to pass attributes to the node icon's DOM element.
     */
    nodeIcon?: TreePassThroughType<
        React.SVGProps<SVGSVGElement> | React.HTMLAttributes<HTMLSpanElement>
    >;
    /**
