...
const classes = {
	...
	list: ({ virtualScrollerOptions, options }) =>
		virtualScrollerOptions
			? classNames("p-autocomplete-items", options.className)
			: "p-autocomplete-items",
	emptyMessage: "p-autocomplete-item",
	item: ({ suggestion, optionGroupLabel }) =>
		optionGroupLabel
			? classNames("p-autocomplete-item", { "p-disabled": suggestion.disabled })
