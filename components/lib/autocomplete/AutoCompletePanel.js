    ...
    React.forwardRef((props, ref) => {
        ...
        const createItem = (suggestion, index, scrollerOptions = {}) => {
            ...
            if (props.optionGroupLabel) {
                const content = props.optionGroupTemplate
                    ? ObjectUtils.getJSXElement(
                          props.optionGroupTemplate,
                          suggestion,
                          index,
                      )
                    : props.getOptionGroupLabel(suggestion);
                const childrenContent = createGroupChildren(
                    suggestion,
                    index,
                    style,
                );
        ...
        const createContent = () => {
            if (
                ...
                ObjectUtils.isEmpty(props.suggestions)
            ) {
                const emptyMessage =
