...
export declare type AutoCompletePassThroughType<T> = PassThroughType<
    T,
...
export declare type AutoCompletePassThroughTransitionType =
    ...
    | ((
          options: AutoCompletePassThroughMethodOptions,
      ) => ReactCSSTransitionProps)
    | undefined;
...
export interface AutoCompletePassThroughOptions {
     ...
     */
    container?: AutoCompletePassThroughType<
     ...
     */
    tokenLabel?: AutoCompletePassThroughType<
        React.HTMLAttributes<HTMLSpanElement>
    >;
    /**
     * Uses to pass attributes to the remove token icon's DOM element.
     */
    removeTokenIcon?: AutoCompletePassThroughType<
     ...
     */
    inputToken?: AutoCompletePassThroughType<
        React.HTMLAttributes<HTMLLIElement>
    >;
    /**
     * Uses to pass attributes to the loading icon's DOM element.
     */
    loadingIcon?: AutoCompletePassThroughType<
        React.SVGProps<SVGSVGElement> | React.HTMLAttributes<HTMLSpanElement>
    >;
    /**
     ...
     */
    itemGroup?: AutoCompletePassThroughType<
        React.HTMLAttributes<HTMLLIElement>
    >;
    /**
     ...
     */
    emptyMessage?: AutoCompletePassThroughType<
        React.HTMLAttributes<HTMLLIElement>
    >;
    /**
 ...
 * @group Component
 */
export declare class AutoComplete extends React.Component<
    AutoCompleteProps,
    any
> {
    /**
    ...
    public search(
        ...
        query: string,
        source?: "dropdown" | "input" | null | undefined,
    ): void;
    /**
