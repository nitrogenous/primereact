...
export declare type ToastPassThroughType<T> = PassThroughType<
	T,
	ToastPassThroughMethodOptions
>;
export declare type ToastPassThroughTransitionType =
	| ReactCSSTransitionProps
	| ((options: ToastPassThroughMethodOptions) => ReactCSSTransitionProps)
	| undefined;
...
export interface ToastPassThroughOptions {
	 ...
	 */
	closeButtonIcon?: ToastPassThroughType<
		React.SVGProps<SVGSVGElement> | React.HTMLAttributes<HTMLSpanElement>
	>;
	/**
