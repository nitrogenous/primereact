    ...
    React.forwardRef((props, ref) => {
        ...
        const onClick = (event) => {
            if (
                props.onClick &&
                !(
                    DomHandler.hasClass(event.target, "p-toast-icon-close") ||
                    DomHandler.hasClass(event.target, "p-toast-icon-close-icon")
                )
            ) {
        ...
        const createMessage = () => {
            if (messageInfo) {
                ...
                const messageIcon = IconUtils.getJSXIcon(
                    icon,
                    { ...iconProps },
                    { props },
                );
