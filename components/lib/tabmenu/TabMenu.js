...
export const TabMenu = React.memo(
    React.forwardRef((inProps, ref) => {
        ...
        const findFirstItem = () => {
            const firstSibling = DomHandler.findSingle(
                navRef.current,
                '[data-pc-section="menuitem"][data-p-disabled="false"]',
            );
        ...
        const findLastItem = () => {
            const siblings = DomHandler.find(
                navRef.current,
                '[data-pc-section="menuitem"][data-p-disabled="false"]',
            );
        ...
        const onTabKey = () => {
            const activeItem = DomHandler.findSingle(
                navRef.current,
                '[data-pc-section="menuitem"][data-p-disabled="false"][data-p-highlight="true"]',
            );
            const focusedItem = DomHandler.findSingle(
                navRef.current,
                '[data-pc-section="action"][tabindex="0"]',
            );
