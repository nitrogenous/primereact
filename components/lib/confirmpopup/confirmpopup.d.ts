...
export declare type ConfirmPopupPassThroughType<T> = PassThroughType<
    T,
...
export declare type ConfirmPopupPassThroughTransitionType =
    ...
    | ((
          options: ConfirmPopupPassThroughMethodOptions,
      ) => ReactCSSTransitionProps)
    | undefined;
...
export interface ConfirmPopupProps {
    ...
    message?:
        | React.ReactNode
        | ((options: ConfirmPopupOptions) => React.ReactNode);
    /**
     * Label of the reject button.
     * @defaultValue No
     */
 ...
 * @group Component
 */
export declare class ConfirmPopup extends React.Component<
    ConfirmPopupProps,
    any
> {
    /**
...
export declare function confirmPopup(
    props: ConfirmPopupProps,
): ConfirmPopupReturn;
