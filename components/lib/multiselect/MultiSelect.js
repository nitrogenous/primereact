...
export const MultiSelect = React.memo(
    React.forwardRef((inProps, ref) => {
        ...
        const [overlayVisibleState, setOverlayVisibleState] = React.useState(
            props.inline,
        );
        ...
        const { ptm, cx, sx, isUnstyled } =
            MultiSelectBase.setMetaData(metaData);
        ...
        const allowOptionSelect = () => {
            return (
                ...
                !props.value ||
                (props.value && props.value.length < props.selectionLimit)
            );
        };
        ...
        const findNextItem = (item) => {
            ...
            return nextItem
                ? DomHandler.getAttribute(nextItem, "data-p-disabled") ===
                      true ||
                  DomHandler.getAttribute(nextItem, "data-pc-section") ===
                      "itemgroup"
        ...
        const findPrevItem = (item) => {
            ...
            return prevItem
                ? DomHandler.getAttribute(prevItem, "data-p-disabled") ===
                      true ||
                  DomHandler.getAttribute(prevItem, "data-pc-section") ===
                      "itemgroup"
        ...
        const onClick = (event) => {
            if (
                ...
                DomHandler.getAttribute(event.target, "data-pc-section") !==
                    "removetokenicon" &&
                !isClearClicked(event)
            ) {
        ...
        const findOptionIndexInList = (value, list) => {
            return list.findIndex((item) =>
                value.some((val) =>
                    ObjectUtils.equals(val, getOptionValue(item), equalityKey),
                ),
            );
        };
        ...
        const findOptionByValue = (val, list) => {
            return list.find((option) =>
                ObjectUtils.equals(getOptionValue(option), val, equalityKey),
            );
        };
        ...
        const getOptionValue = (option) => {
            ...
            if (props.optionValue) {
                const data = ObjectUtils.resolveFieldData(
                    option,
                    props.optionValue,
                );
        ...
        const isOptionValueUsed = (option) => {
            return (
                (!props.useOptionAsValue && props.optionValue) ||
        ...
        const getSelectedItemsLabel = () => {
            ...
            if (pattern.test(props.selectedItemsLabel)) {
                return props.selectedItemsLabel.replace(
                    props.selectedItemsLabel.match(pattern)[0],
                    props.value.length + "",
                );
            }
        ...
        const getLabel = () => {
            ...
            if (!empty && !props.fixedPlaceholder) {
                if (
                    ObjectUtils.isNotEmpty(props.maxSelectedLabels) &&
        ...
        const createClearIcon = () => {
            ...
            const clearIcon = IconUtils.getJSXIcon(
                icon,
                { ...clearIconProps },
                { props },
            );
        ...
        const loadingIcon = props.loadingIcon ? (
            ...
            <SpinnerIcon spin {...triggerIconProps} />
        );
        const dropdownIcon = props.dropdownIcon ? (
            ...
            <ChevronDownIcon {...triggerIconProps} />
        );
        const triggerIcon = (
            <div {...triggerProps}>
                {props.loading ? loadingIcon : dropdownIcon}
            </div>
        );
