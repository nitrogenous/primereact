	...
	React.forwardRef((props, ref) => {
		...
		const createEmptyFilter = () => {
			const emptyFilterMessage =
				ObjectUtils.getJSXElement(props.emptyFilterMessage, props) ||
				localeOption("emptyFilterMessage");
		...
		const createEmptyContent = () => {
			const emptyMessage =
				ObjectUtils.getJSXElement(props.emptyMessage, props) ||
			...
			const panelProps = mergeProps(
				{
					className: classNames(
						...
						cx("panel", { panelProps: props, context, allowOptionSelect }),
					),
