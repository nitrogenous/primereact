...
export declare type MentionPassThroughType<T> = PassThroughType<
	T,
	MentionPassThroughMethodOptions
>;
export declare type MentionPassThroughTransitionType =
	| ReactCSSTransitionProps
	| ((options: MentionPassThroughMethodOptions) => ReactCSSTransitionProps)
	| undefined;
...
export interface MentionProps
	extends Omit<
		React.DetailedHTMLProps<
			...
			HTMLTextAreaElement
		>,
		"onSelect" | "onChange" | "onInput" | "onFocus" | "onBlur" | "ref" | "pt"
	> {
	/**
