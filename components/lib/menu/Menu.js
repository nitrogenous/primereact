...
export const Menu = React.memo(
    React.forwardRef((inProps, ref) => {
        ...
        const popupMenuDisplayOrder = useDisplayOrder(
            "menu",
            !!(visibleState && props.popup),
        );
        ...
        const findNextOptionIndex = (index) => {
            ...
            const matchedOptionIndex = [...links].findIndex(
                (link) => link.id === index,
            );
        ...
        const changeFocusedOptionIndex = (index) => {
            ...
            order > -1 &&
                setFocusedOptionIndex(links[order].getAttribute("id"));
        };
            ...
            const menuitemProps = mergeProps(
                {
                    ...
                    className: classNames(
                        item.className,
                        cx("menuitem", { focused: focusedOptionIndex === key }),
                    ),
