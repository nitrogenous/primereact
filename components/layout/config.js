...
export default function Config(props) {
    ...
    const { ripple, inputStyle, setRipple, setInputStyle } =
    ...
    const isThemeActive = (themeFamily, color) => {
        let themeName;
        const themePrefix =
            themeFamily === "md" && compactMaterial ? "mdc" : themeFamily;
        ...
        >
            <div className="p-2">
                <section className="pb-4 flex align-items-center justify-content-between border-bottom-1 surface-border">
                    ...
                    <div
                        className="flex align-items-center gap-2 border-1 surface-border py-1 px-2"
                ...
                <section className="py-4 flex align-items-center justify-content-between border-bottom-1 surface-border">
                    ...
                    <InputSwitch
                        checked={darkMode}
                        onChange={() => props.onDarkSwitchClick()}
                        disabled={darkToggleDisabled()}
                    />
                </section>
                ...
                <section className="py-4 border-bottom-1 surface-border">
                    ...
                    <div className="flex align-items-center gap-2 mb-3">
                        <img
                            src="https://primefaces.org/cdn/primereact/images/themes/lara-light-teal.png"
                            alt="Lara Light Teal"
                    ...
                    <div className="flex align-items-center justify-content-between gap-3 mb-3">
                        <button
                            className={classNames(
                                ...
                                {
                                    "border-primary": isThemeActive(
                                        "lara",
                                        "cyan",
                                    ),
                                    "hover:border-500 surface-border":
                                        !isThemeActive("lara", "cyan"),
                                },
                            )}
                            style={{ borderRadius: "30px" }}
                        ...
                        >
                            <span
                                ...
                                style={{
                                    borderRadius: " 30px",
                                    background:
                                        "linear-gradient(180deg, #06b6d4 0%, rgba(6, 182, 212, 0.5) 100%)",
                                }}
                            ></span>
                        </button>
                        <button
                        ...
                        >
                            <span
                                ...
                                style={{
                                    borderRadius: " 30px",
                                    background:
                                        "linear-gradient(180deg, #4378e6 0%, rgba(67, 120, 230, 0.5) 100%)",
                                }}
                            ></span>
                        </button>
                        <button
                        ...
                        >
                            <span
                                ...
                                style={{
                                    borderRadius: " 30px",
                                    background:
                                        "linear-gradient(180deg, #585fe0 0%, rgba(88, 95, 224, 0.5) 100%)",
                                }}
                            ></span>
                        </button>
                    </div>
                        ...
                        >
                            <span
                                ...
                                style={{
                                    borderRadius: " 30px",
                                    background:
                                        "linear-gradient(180deg, #7758e4 0%, rgba(119, 88, 228, 0.5) 100%)",
                                }}
                            ></span>
                        </button>
                        <button
                        ...
                        >
                            <span
                                ...
                                style={{
                                    borderRadius: " 30px",
                                    background:
                                        "linear-gradient(180deg, #f59e0b 0%, rgba(245, 158, 11, 0.5) 100%)",
                                }}
                            ></span>
                        </button>
                        <button
                        ...
                        >
                            <span
                                ...
                                style={{
                                    borderRadius: " 30px",
                                    background:
                                        "linear-gradient(180deg, #14b8a6 0%, rgba(20, 184, 166, 0.5) 100%)",
                                }}
                            ></span>
                        </button>
                        <button
                        ...
                        >
                            <span
                                ...
                                style={{
                                    borderRadius: " 30px",
                                    background:
                                        "linear-gradient(180deg, #ec4899 0%, rgba(236, 72, 153, 0.5) 100%)",
                                }}
                            ></span>
                        </button>
                    </div>
                ...
                <section className="py-4 border-bottom-1 surface-border">
                    <div className="flex align-items-center gap-2 mb-3">
                        <img
                            src="https://primefaces.org/cdn/primereact/images/themes/md-light-indigo.svg"
                            alt="Material Design"
                            className="border-circle"
                            style={{ width: "1.5rem" }}
                        />
                        ...
                        <div className="ml-auto flex align-items-center gap-2">
                            ...
                            <InputSwitch
                                ...
                                checked={compactMaterial}
                                onChange={(e) => setCompactMaterial(e.value)}
                                className="ml-auto"
                            />
                        </div>
                    </div>
                        ...
                        >
                            <span
                                ...
                                style={{
                                    borderRadius: "30px",
                                    background:
                                        "linear-gradient(180deg, #0565f2 0%, rgba(5, 101, 242, 0.5) 100%)",
                                }}
                            ></span>
                        </button>
                        <button
                        ...
                        >
                            <span
                                ...
                                style={{
                                    borderRadius: "30px",
                                    background:
                                        "linear-gradient(180deg, #702f92 0%, rgba(112, 47, 146, 0.5) 100%)",
                                }}
                            ></span>
                        </button>
                ...
                <section className="py-4 border-bottom-1 surface-border">
                    <div className="flex align-items-center gap-2 mb-3">
                        <img
                            src="https://primefaces.org/cdn/primereact/images/themes/bootstrap4-light-blue.svg"
                            alt="Bootstrap"
                            className="border-circle"
                            style={{ width: "1.5rem" }}
                        />
                        ...
                        >
                            <span
                                ...
                                style={{
                                    borderRadius: 30,
                                    background:
                                        "linear-gradient(180deg, #027bff 0%, rgba(2, 123, 255, 0.5) 100%)",
                                }}
                            ></span>
                        </button>
                        <button
                            className={classNames(
                                "bg-transparent border-1 cursor-pointer p-2 w-3 flex align-items-center justify-content-center transition-all transition-duration-200",
                                {
                                    ...
                                    "hover:border-500 surface-border":
                                        !isThemeActive("bootstrap4", "purple"),
                                },
                            )}
                            style={{ borderRadius: 30 }}
                ...
                <section className="py-4 border-bottom-1 surface-border">
                    <div className="flex gap-3">
                        <div className="w-3">
                            <div className="flex align-items-center gap-2 mb-3">
                                <img
                                    src="https://primefaces.org/cdn/primereact/images/themes/soho-light.png"
                                    alt="Soho"
                                    className="border-circle"
                                    style={{ width: "1.5rem" }}
                                />
                        ...
                        <div className="w-3">
                            <div className="flex align-items-center gap-2 mb-3">
                                <img
                                    src="https://primefaces.org/cdn/primereact/images/themes/viva-light.svg"
                                    alt="Viva"
                                    className="border-circle"
                                    style={{ width: "1.5rem" }}
                                />
                ...
                <section className="py-4">
                    <div className="flex gap-3">
                        <div className="w-3">
                            <div className="flex align-items-center gap-2 mb-3">
                                <img
                                    src="https://primefaces.org/cdn/primereact/images/themes/fluent-light.png"
                                    alt="Fluent"
                                    className="border-circle"
                                    style={{ width: "1.5rem" }}
                                />
                            ...
                            >
                                <span
                                    ...
                                    style={{
                                        borderRadius: 30,
                                        background:
                                            "linear-gradient(180deg, #0078d4 0%, rgba(0, 120, 212, 0.5) 100%)",
                                    }}
                                ></span>
                            </button>
                        </div>
                        <div className="w-3">
                            <div className="flex align-items-center gap-2 mb-3">
                                <img
                                    src="https://primefaces.org/cdn/primereact/images/themes/mira.jpg"
                                    alt="Mira"
                                    className="border-circle"
                                    style={{ width: "1.5rem" }}
                                />
                        ...
                        <div className="w-3">
                            <div className="flex align-items-center gap-2 mb-3">
                                <img
                                    src="https://primefaces.org/cdn/primereact/images/themes/nano.jpg"
                                    alt="Nano"
                                    className="border-circle"
                                    style={{ width: "1.5rem" }}
                                />
                            ...
                            >
                                <span
                                    ...
                                    style={{
                                        borderRadius: 30,
                                        background:
                                            "linear-gradient(180deg, #1469b4 0%, rgba(20, 105, 180, 0.5) 100%)",
                                    }}
                                ></span>
                            </button>
                        </div>
