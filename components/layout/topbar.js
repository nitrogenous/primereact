            ...
            <div className="layout-topbar-inner">
                ...
                <ul className="flex list-none m-0 p-0 gap-2 align-items-center">
                    <li>
                        <DocSearch
                            appId="SCRI13XXZO"
                            apiKey="ea9e6c8a983c5646d6b9079921d4aed7"
                            indexName="primereact"
                            container=""
                            debug={false}
                    ...
                    <li>
                        ...
                        >
                            <i
                                className={classNames("pi text-700", {
                                    "pi-moon": props.dark,
                                    "pi-sun": !props.dark,
                                })}
                            />
                                    ...
                                    return (
                                        <li key={version.version}>
                                            ...
                                            >
                                                ...
                                                <span className="ml-2 text-700 white-space-nowrap block overflow-hidden text-overflow-ellipsis">
                                                    ({version.version})
                                                </span>
                                            </a>
                                        </li>
