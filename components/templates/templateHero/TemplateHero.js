...
const TemplateHero = ({
	...
	return (
		<div className="template-hero">
			{!!pattern && (
				<img
					className="template-hero-pattern"
					src={pattern}
			...
			<div className="template-hero-card">
				...
				<div className="template-hero-card-buttons">
					<a
						href={liveHref}
						target="_blank"
						className="template-hero-card-buttons-btn1 p-button " rel="noreferrer"
					>
						Live Demo
					</a>
					<a
						...
						target="_blank"
						className="template-hero-card-buttons-btn2 p-button" rel="noreferrer"
					>
						Buy Now
					</a>
				</div>
				<div className="template-hero-card-links ">
					<a
						href="https://github.com/orgs/primefaces/discussions/categories/primereact-templates"
			...
			{!!dashboard1 && (
				<img
					className="template-hero-dashboard1"
					src={dashboard1}
			...
			{!!dashboard2 && (
				<img
					className="template-hero-dashboard2"
					src={dashboard2}
