            ...
            <div className="template-configuration">
                <div className="template-configuration-screen">
                    ...
                    <div className="template-configuration-screen-bottom">
                        <p>
                            &gt;npm install{" "}
                            <span className="text-gray-500">or yarn</span>
                        </p>
                        <p>
                            &gt;npm run dev{" "}
                            <span className="text-gray-500">or yarn dev</span>
                        </p>
                        <br />
                        <br />
                        <img
                            className="template-configuration-screen-bottom-logo"
                            src={"/images/templates/react-3d-logo.png"}
                            alt="Angular 3D Logo"
                        />
                    </div>
                </div>
                <h3 className="template-configuration-title">{title}</h3>
                <p className="template-configuration-description">
                    {description}
                </p>
            </div>
        </div>
