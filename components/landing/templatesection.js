    ...
    return (
        <section className="landing-templates theme-dark py-8">
            ...
            <p className="section-detail relative z-3">
                Professionally designed highly customizable application
                templates to get started in style.
            </p>
                ...
                <div className="flex md:flex-row flex-column gap-4 lg:gap-0">
                    ...
                    >
                        <a
                            ...
                            target="_blank"
                            href="https://verona.primereact.org"
                            rel="noreferrer"
                        >
                            Verona Preview
                        </a>
                    ...
                    >
                        <a
                            className="templates-btn"
                            target="_blank"
                            href="https://freya.primereact.org"
                            rel="noreferrer"
                        >
                            Freya Preview
                        </a>
                ...
                <div className="flex my-4 md:flex-row flex-column gap-4 lg:gap-0">
                    ...
                    >
                        <a
                            className="templates-btn"
                            target="_blank"
                            href="https://atlantis.primereact.org/"
                            rel="noreferrer"
                        >
                            Atlantis Preview
                        </a>
                    ...
                    >
                        <a
                            className="templates-btn"
                            target="_blank"
                            href="https://apollo.primereact.org"
                            rel="noreferrer"
                        >
                            Apollo Preview
                        </a>
                ...
                <div className="flex md:flex-row flex-column gap-4 lg:gap-0">
                    ...
                    >
                        <a
                            className="templates-btn"
                            target="_blank"
                            href="https://diamond.primereact.org"
                            rel="noreferrer"
                        >
                            Diamond Preview
                        </a>
                    ...
                    >
                        <a
                            className="templates-btn"
                            target="_blank"
                            href="https://ultima.primereact.org"
                            rel="noreferrer"
                        >
                            Ultima Preview
                        </a>
