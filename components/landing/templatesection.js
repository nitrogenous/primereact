...
const TemplateSection = () => {
	...
	const imageBg = (template) => {
		...
		return `url('https://primefaces.org/cdn/primereact/images/landing/templates/${template}-${
			darkMode ? "dark" : "light"
		}.${url}')`;
	};

	const templateImg = () => {
		return `https://primefaces.org/cdn/primereact/images/landing/templates/templates-text-new-${
			darkMode ? "dark" : "light"
		}.png`;
	};
	...
	return (
		<section className="landing-templates theme-dark py-8">
			...
			<p className="section-detail relative z-3">
				Professionally designed highly customizable application templates to get
				started in style.
			</p>
			<div className="flex justify-content-center relative mt-4 z-3">
				<a
					href="https://www.primefaces.org/store"
					className="font-semibold p-3 border-round flex align-items-center linkbox active"
				>
			...
			<section
				className={classNames(
					"templates flex justify-content-center align-items-center flex-column mt-7",
			...
			>
				<div className="flex md:flex-row flex-column gap-4 lg:gap-0">
					<div
						...
						style={{ backgroundImage: imageBg("verona") }}
					>
						<a
							className="templates-btn"
							target="_blank"
							href="https://verona.primereact.org" rel="noreferrer"
						>
							Verona Preview
						</a>
					</div>
					...
					>
						<a
							className="templates-btn"
							target="_blank"
							href="https://freya.primereact.org" rel="noreferrer"
						>
							Freya Preview
						</a>
					</div>
				...
				<div className="flex my-4 md:flex-row flex-column gap-4 lg:gap-0">
					...
					>
						<a
							className="templates-btn"
							target="_blank"
							href="https://atlantis.primereact.org/" rel="noreferrer"
						>
							Atlantis Preview
						</a>
					</div>
					...
					>
						<a
							className="templates-btn"
							target="_blank"
							href="https://apollo.primereact.org" rel="noreferrer"
						>
							Apollo Preview
						</a>
					</div>
				...
				<div className="flex md:flex-row flex-column gap-4 lg:gap-0">
					...
					>
						<a
							className="templates-btn"
							target="_blank"
							href="https://diamond.primereact.org" rel="noreferrer"
						>
							Diamond Preview
						</a>
					</div>
					...
					>
						<a
							className="templates-btn"
							target="_blank"
							href="https://ultima.primereact.org" rel="noreferrer"
						>
							Ultima Preview
						</a>
					</div>
