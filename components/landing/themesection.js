...
const ThemeSection = () => {
	...
	useUpdateEffect(() => {
		const newTheme = darkMode
			? tableTheme.replace("light", "dark")
			: tableTheme.replace("dark", "light");
	...
	const actionBodyTemplate = () => {
		return (
			<Button type="button" icon="pi pi-cog" className="p-button-text"></Button>
		);
	};
	...
	return (
		<section className="landing-themes py-8 ">
			...
			<p className="section-detail">
				Crafted on a design-agnostic infrastructure, choose from a vast amount
				of themes such as material, bootstrap, tailwind, primeone or develop
				your own.
			</p>
			<div className="flex flex-wrap justify-content-center">
				...
				<button
					type="button"
					className={classNames("font-medium linkbox mr-3 mt-4", {
						active: tableTheme && tableTheme.startsWith("bootstrap4"),
					})}
			...
			<div
				...
				style={{
					backgroundImage: `url(https://primefaces.org/cdn/primereact/images/landing/wave-${
						darkMode ? "dark-alt-gray" : "light-alt-gray"
					}.svg)`,
