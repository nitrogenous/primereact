	...
	const userTemplate = (rowData) => {
		return (
			<div className="flex align-items-center gap-2">
				<img
					alt={rowData.name}
					src={`https://primefaces.org/cdn/primereact/images/avatar/${rowData.image}`}
					width="32"
				/>
			...
			<div className="flex flex-wrap">
				<div className="w-full xl:w-6 flex flex-column justify-content-center lg:pr-8 align-items-center xl:align-items-stretch">
					...
					<p className="section-detail xl:text-left text-center px-0 mt-0 mb-5">
						Elevate your web applications with PrimeReact's comprehensive suite
						of customizable, feature-rich UI components. With PrimeReact,
						turning your development vision into reality has never been easier.
					</p>
					<div className="flex align-items-center gap-3">
						...
						<a
							...
							className="linkbox font-semibold py-3 px-4"
						>
					...
					<div className="flex">
						<div className="flex flex-column w-6 gap-5 pt-8 pr-3">
							<div className="box p-4 fadein animation-duration-500">
								...
								<span className="text-secondary font-semibold block mt-5 mb-3">
									Account
								</span>
						...
						<div className="flex flex-column w-6 gap-5 pl-3">
							<div className="box p-4 fadein animation-duration-500">
								<div
									className="surface-card mb-4 w-full text-center p-5"
							...
							<div className="box p-4 fadein animation-duration-500">
								<ul className="list-none p-0 m-0">
									<li className="flex align-items-center mb-3">
										<span className="mr-3">
											<img
												src="https://primefaces.org/cdn/primereact/images/landing/avatar.png"
												alt="Avatar"
									...
									<li className="flex">
										<a
											className="flex align-items-center p-3 border-round w-full hover:surface-hover transition-colors transition-duration-150 cursor-pointer"
											style={{ borderRadius: "10px" }}
										>
