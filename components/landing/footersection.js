        ...
        <section className="landing-footer pt-8 px-5 lg:px-8">
            <div className="landing-footer-container">
                <div className="flex flex-wrap z-1">
                        ...
                        <ul className="list-none p-0 m-0">
                            ...
                            <li className="mb-4">
                                <Link href="/installation">
                                    <a className="text-secondary font-medium hover:text-primary transition-colors transition-duration-150">
                                        Get Started
                                    </a>
                                </Link>
                            </li>
                            <li className="mb-4">
                                <a
                                    href="https://github.com/primefaces/primereact-examples"
                                    className="text-secondary font-medium hover:text-primary transition-colors transition-duration-150"
                                    target="_blank"
                    ...
                    <div className="w-6 lg:w-3 flex">
                        <ul className="list-none p-0 m-0">
                            <li className="font-bold mt-5 lg:mt-0 mb-5">
                                Resources
                            </li>
                            <li className="mb-4">
                                <a
                ...
                <div className="flex flex-wrap justify-content-between py-6 gap-5">
                        ...
                        >
                            ...
                            >
                                <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                                    d="M0.946167 0.0430908H32.1679V34.0431H0.946167V0.0430908Z"
                                    fill="white"
                                />
                            </mask>
                    ...
                    <div className="flex align-items-center">
                        <a
                            href="https://twitter.com/primereact"
                            className="linkbox block w-3rem h-3rem flex align-items-center justify-content-center mr-3"
                        >
                        ...
                        <a
                            href="https://github.com/orgs/primefaces/discussions"
                            className="linkbox block w-3rem h-3rem flex align-items-center justify-content-center"
                        >
